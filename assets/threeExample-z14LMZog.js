...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function Cp(i,e,t){const n=new Float32Array(Kn),r=new U(0,1,0);return new un({name:"SphericalGaussianBlur",defines:{n:Kn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:aa(),fragmentShader:`
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function ul(){return new un({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:aa(),fragmentShader:`
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function hl(){return new un({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:aa(),fragmentShader:`
	...
	`}class _c extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new dc(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new nr(5,5,5),a=new un({name:"CubemapFromEquirect",uniforms:Ii(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Lt,blending:Tn});a.uniforms.tEquirect.value=t;const s=new kt(r,a),o=t.minFilter;return t.minFilter===Sn&&(t.minFilter=pt),new Dh(1,10,this).update(e,s),t.minFilter=o,s.geometry.dispose(),s.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const a=e.getRenderTarget();for(let s=0;s<6;s++)e.setRenderTarget(this,s),e.clear(t,n,r);e.setRenderTarget(a)}}function wp(i){let e=new WeakMap,t=new WeakMap,n=null;function r(u,m=!1){return u==null?null:m?s(u):a(u)}function a(u){if(u&&u.isTexture){const m=u.mapping;if(m===ma||m===ga)if(e.has(u)){const _=e.get(u).texture;return o(_,u.mapping)}else{const _=u.image;if(_&&_.height>0){const S=new _c(_.height);return S.fromEquirectangularTexture(i,u),e.set(u,S),u.addEventListener("dispose",c),o(S.texture,u.mapping)}else return null}}return u}function s(u){if(u&&u.isTexture){const m=u.mapping,_=m===ma||m===ga,S=m===ei||m===Pi;if(_||S){let f=t.get(u);const h=f!==void 0?f.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==h)return n===null&&(n=new ll(i)),f=_?n.fromEquirectangular(u,f):n.fromCubemap(u,f),f.texture.pmremVersion=u.pmremVersion,t.set(u,f),f.texture;if(f!==void 0)return f.texture;{const M=u.image;return _&&M&&M.height>0||S&&M&&l(M)?(n===null&&(n=new ll(i)),f=_?n.fromEquirectangular(u):n.fromCubemap(u),f.texture.pmremVersion=u.pmremVersion,t.set(u,f),u.addEventListener("dispose",d),f.texture):null}}}return u}function o(u,m){return m===ma?u.mapping=ei:m===ga&&(u.mapping=Pi),u}function l(u){let m=0;const _=6;for(let S=0;S<_;S++)u[S]!==void 0&&m++;return m===_}function c(u){const m=u.target;m.removeEventListener("dispose",c);const _=e.get(m);_!==void 0&&(e.delete(m),_.dispose())}function d(u){const m=u.target;m.removeEventListener("dispose",d);const _=t.get(m);_!==void 0&&(t.delete(m),_.dispose())}function p(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:p}}function Rp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Wr("WebGLRenderer: "+n+" extension not supported."),r}}}function Pp(i,e,t,n){const r={},a=new WeakMap;function s(p){const u=p.target;u.index!==null&&e.remove(u.index);for(const _ in u.attributes)e.remove(u.attributes[_]);u.removeEventListener("dispose",s),delete r[u.id];const m=a.get(u);m&&(e.remove(m),a.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(p,u){return r[u.id]===!0||(u.addEventListener("dispose",s),r[u.id]=!0,t.memory.geometries++),u}function l(p){const u=p.attributes;for(const m in u)e.update(u[m],i.ARRAY_BUFFER)}function c(p){const u=[],m=p.index,_=p.attributes.position;let S=0;if(_===void 0)return;if(m!==null){const M=m.array;S=m.version;for(let b=0,E=M.length;b<E;b+=3){const R=M[b+0],A=M[b+1],D=M[b+2];u.push(R,A,A,D,D,R)}}else{const M=_.array;S=_.version;for(let b=0,E=M.length/3-1;b<E;b+=3){const R=b+0,A=b+1,D=b+2;u.push(R,A,A,D,D,R)}}const f=new(_.count>=65535?cc:lc)(u,1);f.version=S;const h=a.get(p);h&&e.remove(h),a.set(p,f)}function d(p){const u=a.get(p);if(u){const m=p.index;m!==null&&u.version<m.version&&c(p)}else c(p);return a.get(p)}return{get:o,update:l,getWireframeAttribute:d}}function Dp(i,e,t){let n;function r(u){n=u}let a,s;function o(u){a=u.type,s=u.bytesPerElement}function l(u,m){i.drawElements(n,m,a,u*s),t.update(m,n,1)}function c(u,m,_){_!==0&&(i.drawElementsInstanced(n,m,a,u*s,_),t.update(m,n,_))}function d(u,m,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,a,u,0,_);let f=0;for(let h=0;h<_;h++)f+=m[h];t.update(f,n,1)}function p(u,m,_,S){if(_===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let h=0;h<u.length;h++)c(u[h]/s,m[h],S[h]);else{f.multiDrawElementsInstancedWEBGL(n,m,0,a,u,0,S,0,_);let h=0;for(let M=0;M<_;M++)h+=m[M]*S[M];t.update(h,n,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d,this.renderMultiDrawInstances=p}function Lp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(a,s,o){switch(t.calls++,s){case i.TRIANGLES:t.triangles+=o*(a/3);break;case i.LINES:t.lines+=o*(a/2);break;case i.LINE_STRIP:t.lines+=o*(a-1);break;case i.LINE_LOOP:t.lines+=o*a;break;case i.POINTS:t.points+=o*a;break;default:He("WebGLInfo: Unknown draw mode:",s);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Ip(i,e,t){const n=new WeakMap,r=new ht;function a(s,o,l){const c=s.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=d!==void 0?d.length:0;let u=n.get(o);if(u===void 0||u.count!==p){let y=function(){D.dispose(),n.delete(o),o.removeEventListener("dispose",y)};u!==void 0&&u.texture.dispose();const m=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,S=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],h=o.morphAttributes.normal||[],M=o.morphAttributes.color||[];let b=0;m===!0&&(b=1),_===!0&&(b=2),S===!0&&(b=3);let E=o.attributes.position.count*b,R=1;E>e.maxTextureSize&&(R=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const A=new Float32Array(E*R*4*p),D=new sc(A,E,R,p);D.type=Ht,D.needsUpdate=!0;const x=b*4;for(let q=0;q<p;q++){const w=f[q],G=h[q],B=M[q],k=E*R*4*q;for(let V=0;V<w.count;V++){const z=V*x;m===!0&&(r.fromBufferAttribute(w,V),A[k+z+0]=r.x,A[k+z+1]=r.y,A[k+z+2]=r.z,A[k+z+3]=0),_===!0&&(r.fromBufferAttribute(G,V),A[k+z+4]=r.x,A[k+z+5]=r.y,A[k+z+6]=r.z,A[k+z+7]=0),S===!0&&(r.fromBufferAttribute(B,V),A[k+z+8]=r.x,A[k+z+9]=r.y,A[k+z+10]=r.z,A[k+z+11]=B.itemSize===4?r.w:1)}}u={count:p,texture:D,size:new Ie(E,R)},n.set(o,u),o.addEventListener("dispose",y)}if(s.isInstancedMesh===!0&&s.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",s.morphTexture,t);else{let m=0;for(let S=0;S<c.length;S++)m+=c[S];const _=o.morphTargetsRelative?1:1-m;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",u.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:a}}function Up(i,e,t,n,r){let a=new WeakMap;function s(c){const d=r.render.frame,p=c.geometry,u=e.get(c,p);if(a.get(u)!==d&&(e.update(u),a.set(u,d)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),a.get(c)!==d&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),a.set(c,d))),c.isSkinnedMesh){const m=c.skeleton;a.get(m)!==d&&(m.update(),a.set(m,d))}return u}function o(){a=new WeakMap}function l(c){const d=c.target;d.removeEventListener("dispose",l),n.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:s,dispose:o}}const Fp={[Xl]:"LINEAR_TONE_MAPPING",[ql]:"REINHARD_TONE_MAPPING",[Yl]:"CINEON_TONE_MAPPING",[$l]:"ACES_FILMIC_TONE_MAPPING",[Zl]:"AGX_TONE_MAPPING",[Kl]:"NEUTRAL_TONE_MAPPING",[jl]:"CUSTOM_TONE_MAPPING"};function Np(i,e,t,n,r){const a=new Jt(e,t,{type:i,depthBuffer:n,stencilBuffer:r}),s=new Jt(e,t,{type:bn,depthBuffer:!1,stencilBuffer:!1}),o=new hn;o.setAttribute("position",new En([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new En([0,2,0,0,2,0],2));const l=new $i({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new kt(o,l),d=new ra(-1,1,1,-1,0,1);let p=null,u=null,m=!1,_,S=null,f=[],h=!1;this.setSize=function(M,b){a.setSize(M,b),s.setSize(M,b);for(let E=0;E<f.length;E++){const R=f[E];R.setSize&&R.setSize(M,b)}},this.setEffects=function(M){f=M,h=f.length>0&&f[0].isRenderPass===!0;const b=a.width,E=a.height;for(let R=0;R<f.length;R++){const A=f[R];A.setSize&&A.setSize(b,E)}},this.begin=function(M,b){if(m||M.toneMapping===on&&f.length===0)return!1;if(S=b,b!==null){const E=b.width,R=b.height;(a.width!==E||a.height!==R)&&this.setSize(E,R)}return h===!1&&M.setRenderTarget(a),_=M.toneMapping,M.toneMapping=on,!0},this.hasRenderPass=function(){return h},this.end=function(M,b){M.toneMapping=_,m=!0;let E=a,R=s;for(let A=0;A<f.length;A++){const D=f[A];if(D.enabled!==!1&&(D.render(M,R,E,b),D.needsSwap!==!1)){const x=E;E=R,R=x}}if(p!==M.outputColorSpace||u!==M.toneMapping){p=M.outputColorSpace,u=M.toneMapping,l.defines={},ke.getTransfer(p)===Ze&&(l.defines.SRGB_TRANSFER="");const A=Fp[u];A&&(l.defines[A]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=E.texture,M.setRenderTarget(S),M.render(c,d),S=null,m=!1},this.isCompositing=function(){return m},this.dispose=function(){a.dispose(),s.dispose(),o.dispose(),l.dispose()}}const xc=new wt,qs=new Qi(1,1),vc=new sc,Sc=new nh,Mc=new dc,dl=[],fl=[],pl=new Float32Array(16),ml=new Float32Array(9),gl=new Float32Array(4);function Fi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let a=dl[r];if(a===void 0&&(a=new Float32Array(r),dl[r]=a),e!==0){n.toArray(a,0);for(let s=1,o=0;s!==e;++s)o+=t,i[s].toArray(a,o)}return a}function _t(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function xt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function sa(i,e){let t=fl[e];t===void 0&&(t=new Int32Array(e),fl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Op(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Bp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;i.uniform2fv(this.addr,e),xt(t,e)}}function zp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(_t(t,e))return;i.uniform3fv(this.addr,e),xt(t,e)}}function Gp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;i.uniform4fv(this.addr,e),xt(t,e)}}function Vp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),xt(t,e)}else{if(_t(t,n))return;gl.set(n),i.uniformMatrix2fv(this.addr,!1,gl),xt(t,n)}}function Hp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),xt(t,e)}else{if(_t(t,n))return;ml.set(n),i.uniformMatrix3fv(this.addr,!1,ml),xt(t,n)}}function kp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),xt(t,e)}else{if(_t(t,n))return;pl.set(n),i.uniformMatrix4fv(this.addr,!1,pl),xt(t,n)}}function Wp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Xp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;i.uniform2iv(this.addr,e),xt(t,e)}}function qp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;i.uniform3iv(this.addr,e),xt(t,e)}}function Yp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;i.uniform4iv(this.addr,e),xt(t,e)}}function $p(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function jp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;i.uniform2uiv(this.addr,e),xt(t,e)}}function Zp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;i.uniform3uiv(this.addr,e),xt(t,e)}}function Kp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;i.uniform4uiv(this.addr,e),xt(t,e)}}function Jp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let a;this.type===i.SAMPLER_2D_SHADOW?(qs.compareFunction=t.isReversedDepthBuffer()?so:ao,a=qs):a=xc,t.setTexture2D(e||a,r)}function Qp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Sc,r)}function em(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Mc,r)}function tm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||vc,r)}function nm(i){switch(i){case 5126:return Op;case 35664:return Bp;case 35665:return zp;case 35666:return Gp;case 35674:return Vp;case 35675:return Hp;case 35676:return kp;case 5124:case 35670:return Wp;case 35667:case 35671:return Xp;case 35668:case 35672:return qp;case 35669:case 35673:return Yp;case 5125:return $p;case 36294:return jp;case 36295:return Zp;case 36296:return Kp;case 35678:case 36198:case 36298:case 36306:case 35682:return Jp;case 35679:case 36299:case 36307:return Qp;case 35680:case 36300:case 36308:case 36293:return em;case 36289:case 36303:case 36311:case 36292:return tm}}function im(i,e){i.uniform1fv(this.addr,e)}function rm(i,e){const t=Fi(e,this.size,2);i.uniform2fv(this.addr,t)}function am(i,e){const t=Fi(e,this.size,3);i.uniform3fv(this.addr,t)}function sm(i,e){const t=Fi(e,this.size,4);i.uniform4fv(this.addr,t)}function om(i,e){const t=Fi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function lm(i,e){const t=Fi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function cm(i,e){const t=Fi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function um(i,e){i.uniform1iv(this.addr,e)}function hm(i,e){i.uniform2iv(this.addr,e)}function dm(i,e){i.uniform3iv(this.addr,e)}function fm(i,e){i.uniform4iv(this.addr,e)}function pm(i,e){i.uniform1uiv(this.addr,e)}function mm(i,e){i.uniform2uiv(this.addr,e)}function gm(i,e){i.uniform3uiv(this.addr,e)}function _m(i,e){i.uniform4uiv(this.addr,e)}function xm(i,e,t){const n=this.cache,r=e.length,a=sa(t,r);_t(n,a)||(i.uniform1iv(this.addr,a),xt(n,a));let s;this.type===i.SAMPLER_2D_SHADOW?s=qs:s=xc;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||s,a[o])}function vm(i,e,t){const n=this.cache,r=e.length,a=sa(t,r);_t(n,a)||(i.uniform1iv(this.addr,a),xt(n,a));for(let s=0;s!==r;++s)t.setTexture3D(e[s]||Sc,a[s])}function Sm(i,e,t){const n=this.cache,r=e.length,a=sa(t,r);_t(n,a)||(i.uniform1iv(this.addr,a),xt(n,a));for(let s=0;s!==r;++s)t.setTextureCube(e[s]||Mc,a[s])}function Mm(i,e,t){const n=this.cache,r=e.length,a=sa(t,r);_t(n,a)||(i.uniform1iv(this.addr,a),xt(n,a));for(let s=0;s!==r;++s)t.setTexture2DArray(e[s]||vc,a[s])}function Tm(i){switch(i){case 5126:return im;case 35664:return rm;case 35665:return am;case 35666:return sm;case 35674:return om;case 35675:return lm;case 35676:return cm;case 5124:case 35670:return um;case 35667:case 35671:return hm;case 35668:case 35672:return dm;case 35669:case 35673:return fm;case 5125:return pm;case 36294:return mm;case 36295:return gm;case 36296:return _m;case 35678:case 36198:case 36298:case 36306:case 35682:return xm;case 35679:case 36299:case 36307:return vm;case 35680:case 36300:case 36308:case 36293:return Sm;case 36289:case 36303:case 36311:case 36292:return Mm}}class ym{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=nm(t.type)}}class Em{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Tm(t.type)}}class bm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let a=0,s=r.length;a!==s;++a){const o=r[a];o.setValue(e,t[o.id],n)}}}const Xa=/(\w+)(\])?(\[|\.)?/g;function _l(i,e){i.seq.push(e),i.map[e.id]=e}function Am(i,e,t){const n=i.name,r=n.length;for(Xa.lastIndex=0;;){const a=Xa.exec(n),s=Xa.lastIndex;let o=a[1];const l=a[2]==="]",c=a[3];if(l&&(o=o|0),c===void 0||c==="["&&s+2===r){_l(t,c===void 0?new ym(o,i,e):new Em(o,i,e));break}else{let p=t.map[o];p===void 0&&(p=new bm(o),_l(t,p)),t=p}}}class Gr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const o=e.getActiveUniform(t,s),l=e.getUniformLocation(t,o.name);Am(o,l,this)}const r=[],a=[];for(const s of this.seq)s.type===e.SAMPLER_2D_SHADOW||s.type===e.SAMPLER_CUBE_SHADOW||s.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(s):a.push(s);r.length>0&&(this.seq=r.concat(a))}setValue(e,t,n,r){const a=this.map[t];a!==void 0&&a.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let a=0,s=t.length;a!==s;++a){const o=t[a],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,a=e.length;r!==a;++r){const s=e[r];s.id in t&&n.push(s)}return n}}function xl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Cm=37297;let wm=0;function Rm(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let s=r;s<a;s++){const o=s+1;n.push(`${o===e?">":" "} ${o}: ${t[s]}`)}return n.join(`
`)}const vl=new Ue;function Pm(i){ke._getMatrix(vl,ke.workingColorSpace,i);const e=`mat3( ${vl.elements.map(t=>t.toFixed(4))} )`;switch(ke.getTransfer(i)){case Vr:return[e,"LinearTransferOETF"];case Ze:return[e,"sRGBTransferOETF"];default:return Re("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Sl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),a=(i.getShaderInfoLog(e)||"").trim();if(n&&a==="")return"";const s=/ERROR: 0:(\d+)/.exec(a);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+a+`

`+Rm(i.getShaderSource(e),o)}else return a}function Dm(i,e){const t=Pm(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Lm={[Xl]:"Linear",[ql]:"Reinhard",[Yl]:"Cineon",[$l]:"ACESFilmic",[Zl]:"AgX",[Kl]:"Neutral",[jl]:"Custom"};function Im(i,e){const t=Lm[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Cr=new U;function Um(){ke.getLuminanceCoefficients(Cr);const i=Cr.x.toFixed(4),e=Cr.y.toFixed(4),t=Cr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Fm(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ji).join(`
`)}function Nm(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Om(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const a=i.getActiveAttrib(e,r),s=a.name;let o=1;a.type===i.FLOAT_MAT2&&(o=2),a.type===i.FLOAT_MAT3&&(o=3),a.type===i.FLOAT_MAT4&&(o=4),t[s]={type:a.type,location:i.getAttribLocation(e,s),locationSize:o}}return t}function ji(i){return i!==""}function Ml(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Tl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Bm=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ys(i){return i.replace(Bm,Gm)}const zm=new Map;function Gm(i,e){let t=Fe[e];if(t===void 0){const n=zm.get(e);if(n!==void 0)t=Fe[n],Re('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ys(t)}const Vm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function yl(i){return i.replace(Vm,Hm)}function Hm(i,e,t,n){let r="";for(let a=parseInt(e);a<parseInt(t);a++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return r}function El(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const km={[Ur]:"SHADOWMAP_TYPE_PCF",[Yi]:"SHADOWMAP_TYPE_VSM"};function Wm(i){return km[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Xm={[ei]:"ENVMAP_TYPE_CUBE",[Pi]:"ENVMAP_TYPE_CUBE",[ta]:"ENVMAP_TYPE_CUBE_UV"};function qm(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Xm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Ym={[Pi]:"ENVMAP_MODE_REFRACTION"};function $m(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Ym[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const jm={[Wl]:"ENVMAP_BLENDING_MULTIPLY",[Iu]:"ENVMAP_BLENDING_MIX",[Uu]:"ENVMAP_BLENDING_ADD"};function Zm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":jm[i.combine]||"ENVMAP_BLENDING_NONE"}function Km(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Jm(i,e,t,n){const r=i.getContext(),a=t.defines;let s=t.vertexShader,o=t.fragmentShader;const l=Wm(t),c=qm(t),d=$m(t),p=Zm(t),u=Km(t),m=Fm(t),_=Nm(a),S=r.createProgram();let f,h,M=t.glslVersion?"#version "+t.glslVersion+`
...
}`;class Tg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new fc(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new un({vertexShader:Sg,fragmentShader:Mg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new kt(new ia(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class yg extends ni{constructor(e,t){super();const n=this;let r=null,a=1,s=null,o="local-floor",l=1,c=null,d=null,p=null,u=null,m=null,_=null;const S=typeof XRWebGLBinding<"u",f=new Tg,h={},M=t.getContextAttributes();let b=null,E=null;const R=[],A=[],D=new Ie;let x=null;const y=new jt;y.viewport=new ht;const q=new jt;q.viewport=new ht;const w=[y,q],G=new Lh;let B=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let j=R[$];return j===void 0&&(j=new Ea,R[$]=j),j.getTargetRaySpace()},this.getControllerGrip=function($){let j=R[$];return j===void 0&&(j=new Ea,R[$]=j),j.getGripSpace()},this.getHand=function($){let j=R[$];return j===void 0&&(j=new Ea,R[$]=j),j.getHandSpace()};function V($){const j=A.indexOf($.inputSource);if(j===-1)return;const J=R[j];J!==void 0&&(J.update($.inputSource,$.frame,c||s),J.dispatchEvent({type:$.type,data:$.inputSource}))}function z(){r.removeEventListener("select",V),r.removeEventListener("selectstart",V),r.removeEventListener("selectend",V),r.removeEventListener("squeeze",V),r.removeEventListener("squeezestart",V),r.removeEventListener("squeezeend",V),r.removeEventListener("end",z),r.removeEventListener("inputsourceschange",O);for(let $=0;$<R.length;$++){const j=A[$];j!==null&&(A[$]=null,R[$].disconnect(j))}B=null,k=null,f.reset();for(const $ in h)delete h[$];e.setRenderTarget(b),m=null,u=null,p=null,r=null,E=null,Ye.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(D.width,D.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){a=$,n.isPresenting===!0&&Re("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){o=$,n.isPresenting===!0&&Re("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||s},this.setReferenceSpace=function($){c=$},this.getBaseLayer=function(){return u!==null?u:m},this.getBinding=function(){return p===null&&S&&(p=new XRWebGLBinding(r,t)),p},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function($){if(r=$,r!==null){if(b=e.getRenderTarget(),r.addEventListener("select",V),r.addEventListener("selectstart",V),r.addEventListener("selectend",V),r.addEventListener("squeeze",V),r.addEventListener("squeezestart",V),r.addEventListener("squeezeend",V),r.addEventListener("end",z),r.addEventListener("inputsourceschange",O),M.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(D),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let J=null,me=null,Ae=null;M.depth&&(Ae=M.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,J=M.stencil?Qn:An,me=M.stencil?Ji:ln);const ye={colorFormat:t.RGBA8,depthFormat:Ae,scaleFactor:a};p=this.getBinding(),u=p.createProjectionLayer(ye),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),E=new Jt(u.textureWidth,u.textureHeight,{format:Dt,type:Gt,depthTexture:new Qi(u.textureWidth,u.textureHeight,me,void 0,void 0,void 0,void 0,void 0,void 0,J),stencilBuffer:M.stencil,colorSpace:e.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const J={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:a};m=new XRWebGLLayer(r,t,J),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),E=new Jt(m.framebufferWidth,m.framebufferHeight,{format:Dt,type:Gt,colorSpace:e.outputColorSpace,stencilBuffer:M.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,s=await r.requestReferenceSpace(o),Ye.setContext(r),Ye.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return f.getDepthTexture()};function O($){for(let j=0;j<$.removed.length;j++){const J=$.removed[j],me=A.indexOf(J);me>=0&&(A[me]=null,R[me].disconnect(J))}for(let j=0;j<$.added.length;j++){const J=$.added[j];let me=A.indexOf(J);if(me===-1){for(let ye=0;ye<R.length;ye++)if(ye>=A.length){A.push(J),me=ye;break}else if(A[ye]===null){A[ye]=J,me=ye;break}if(me===-1)break}const Ae=R[me];Ae&&Ae.connect(J)}}const Q=new U,K=new U;function ce($,j,J){Q.setFromMatrixPosition(j.matrixWorld),K.setFromMatrixPosition(J.matrixWorld);const me=Q.distanceTo(K),Ae=j.projectionMatrix.elements,ye=J.projectionMatrix.elements,vt=Ae[14]/(Ae[10]-1),Ve=Ae[14]/(Ae[10]+1),$e=(Ae[9]+1)/Ae[5],tt=(Ae[9]-1)/Ae[5],Ne=(Ae[8]-1)/Ae[0],lt=(ye[8]+1)/ye[0],C=vt*Ne,dt=vt*lt,Xe=me/(-Ne+lt),it=Xe*-Ne;if(j.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(it),$.translateZ(Xe),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Ae[10]===-1)$.projectionMatrix.copy(j.projectionMatrix),$.projectionMatrixInverse.copy(j.projectionMatrixInverse);else{const Me=vt+Xe,T=Ve+Xe,g=C-it,L=dt+(me-it),Y=$e*Ve/T*Me,Z=tt*Ve/T*Me;$.projectionMatrix.makePerspective(g,L,Y,Z,Me,T),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function fe($,j){j===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(j.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(r===null)return;let j=$.near,J=$.far;f.texture!==null&&(f.depthNear>0&&(j=f.depthNear),f.depthFar>0&&(J=f.depthFar)),G.near=q.near=y.near=j,G.far=q.far=y.far=J,(B!==G.near||k!==G.far)&&(r.updateRenderState({depthNear:G.near,depthFar:G.far}),B=G.near,k=G.far),G.layers.mask=$.layers.mask|6,y.layers.mask=G.layers.mask&-5,q.layers.mask=G.layers.mask&-3;const me=$.parent,Ae=G.cameras;fe(G,me);for(let ye=0;ye<Ae.length;ye++)fe(Ae[ye],me);Ae.length===2?ce(G,y,q):G.projectionMatrix.copy(y.projectionMatrix),ue($,G,me)};function ue($,j,J){J===null?$.matrix.copy(j.matrixWorld):($.matrix.copy(J.matrixWorld),$.matrix.invert(),$.matrix.multiply(j.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(j.projectionMatrix),$.projectionMatrixInverse.copy(j.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=ks*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return G},this.getFoveation=function(){if(!(u===null&&m===null))return l},this.setFoveation=function($){l=$,u!==null&&(u.fixedFoveation=$),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=$)},this.hasDepthSensing=function(){return f.texture!==null},this.getDepthSensingMesh=function(){return f.getMesh(G)},this.getCameraTexture=function($){return h[$]};let De=null;function et($,j){if(d=j.getViewerPose(c||s),_=j,d!==null){const J=d.views;m!==null&&(e.setRenderTargetFramebuffer(E,m.framebuffer),e.setRenderTarget(E));let me=!1;J.length!==G.cameras.length&&(G.cameras.length=0,me=!0);for(let Ve=0;Ve<J.length;Ve++){const $e=J[Ve];let tt=null;if(m!==null)tt=m.getViewport($e);else{const lt=p.getViewSubImage(u,$e);tt=lt.viewport,Ve===0&&(e.setRenderTargetTextures(E,lt.colorTexture,lt.depthStencilTexture),e.setRenderTarget(E))}let Ne=w[Ve];Ne===void 0&&(Ne=new jt,Ne.layers.enable(Ve),Ne.viewport=new ht,w[Ve]=Ne),Ne.matrix.fromArray($e.transform.matrix),Ne.matrix.decompose(Ne.position,Ne.quaternion,Ne.scale),Ne.projectionMatrix.fromArray($e.projectionMatrix),Ne.projectionMatrixInverse.copy(Ne.projectionMatrix).invert(),Ne.viewport.set(tt.x,tt.y,tt.width,tt.height),Ve===0&&(G.matrix.copy(Ne.matrix),G.matrix.decompose(G.position,G.quaternion,G.scale)),me===!0&&G.cameras.push(Ne)}const Ae=r.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&S){p=n.getBinding();const Ve=p.getDepthInformation(J[0]);Ve&&Ve.isValid&&Ve.texture&&f.init(Ve,r.renderState)}if(Ae&&Ae.includes("camera-access")&&S){e.state.unbindTexture(),p=n.getBinding();for(let Ve=0;Ve<J.length;Ve++){const $e=J[Ve].camera;if($e){let tt=h[$e];tt||(tt=new fc,h[$e]=tt);const Ne=p.getCameraImage($e);tt.sourceTexture=Ne}}}}for(let J=0;J<R.length;J++){const me=A[J],Ae=R[J];me!==null&&Ae!==void 0&&Ae.update(me,j,c||s)}De&&De($,j),j.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:j}),_=null}const Ye=new gc;Ye.setAnimationLoop(et),this.setAnimationLoop=function($){De=$},this.dispose=function(){}}}const jn=new wn,Eg=new qe;function bg(i,e){function t(f,h){f.matrixAutoUpdate===!0&&f.updateMatrix(),h.value.copy(f.matrix)}function n(f,h){h.color.getRGB(f.fogColor.value,pc(i)),h.isFog?(f.fogNear.value=h.near,f.fogFar.value=h.far):h.isFogExp2&&(f.fogDensity.value=h.density)}function r(f,h,M,b,E){h.isMeshBasicMaterial?a(f,h):h.isMeshLambertMaterial?(a(f,h),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(a(f,h),p(f,h)):h.isMeshPhongMaterial?(a(f,h),d(f,h),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(a(f,h),u(f,h),h.isMeshPhysicalMaterial&&m(f,h,E)):h.isMeshMatcapMaterial?(a(f,h),_(f,h)):h.isMeshDepthMaterial?a(f,h):h.isMeshDistanceMaterial?(a(f,h),S(f,h)):h.isMeshNormalMaterial?a(f,h):h.isLineBasicMaterial?(s(f,h),h.isLineDashedMaterial&&o(f,h)):h.isPointsMaterial?l(f,h,M,b):h.isSpriteMaterial?c(f,h):h.isShadowMaterial?(f.color.value.copy(h.color),f.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function a(f,h){f.opacity.value=h.opacity,h.color&&f.diffuse.value.copy(h.color),h.emissive&&f.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.bumpMap&&(f.bumpMap.value=h.bumpMap,t(h.bumpMap,f.bumpMapTransform),f.bumpScale.value=h.bumpScale,h.side===Lt&&(f.bumpScale.value*=-1)),h.normalMap&&(f.normalMap.value=h.normalMap,t(h.normalMap,f.normalMapTransform),f.normalScale.value.copy(h.normalScale),h.side===Lt&&f.normalScale.value.negate()),h.displacementMap&&(f.displacementMap.value=h.displacementMap,t(h.displacementMap,f.displacementMapTransform),f.displacementScale.value=h.displacementScale,f.displacementBias.value=h.displacementBias),h.emissiveMap&&(f.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,f.emissiveMapTransform)),h.specularMap&&(f.specularMap.value=h.specularMap,t(h.specularMap,f.specularMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest);const M=e.get(h),b=M.envMap,E=M.envMapRotation;b&&(f.envMap.value=b,jn.copy(E),jn.x*=-1,jn.y*=-1,jn.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(jn.y*=-1,jn.z*=-1),f.envMapRotation.value.setFromMatrix4(Eg.makeRotationFromEuler(jn)),f.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,f.reflectivity.value=h.reflectivity,f.ior.value=h.ior,f.refractionRatio.value=h.refractionRatio),h.lightMap&&(f.lightMap.value=h.lightMap,f.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,f.lightMapTransform)),h.aoMap&&(f.aoMap.value=h.aoMap,f.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,f.aoMapTransform))}function s(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform))}function o(f,h){f.dashSize.value=h.dashSize,f.totalSize.value=h.dashSize+h.gapSize,f.scale.value=h.scale}function l(f,h,M,b){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.size.value=h.size*M,f.scale.value=b*.5,h.map&&(f.map.value=h.map,t(h.map,f.uvTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function c(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.rotation.value=h.rotation,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function d(f,h){f.specular.value.copy(h.specular),f.shininess.value=Math.max(h.shininess,1e-4)}function p(f,h){h.gradientMap&&(f.gradientMap.value=h.gradientMap)}function u(f,h){f.metalness.value=h.metalness,h.metalnessMap&&(f.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,f.metalnessMapTransform)),f.roughness.value=h.roughness,h.roughnessMap&&(f.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,f.roughnessMapTransform)),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)}function m(f,h,M){f.ior.value=h.ior,h.sheen>0&&(f.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),f.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(f.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,f.sheenColorMapTransform)),h.sheenRoughnessMap&&(f.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,f.sheenRoughnessMapTransform))),h.clearcoat>0&&(f.clearcoat.value=h.clearcoat,f.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(f.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,f.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(f.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,f.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(f.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,f.clearcoatNormalMapTransform),f.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Lt&&f.clearcoatNormalScale.value.negate())),h.dispersion>0&&(f.dispersion.value=h.dispersion),h.iridescence>0&&(f.iridescence.value=h.iridescence,f.iridescenceIOR.value=h.iridescenceIOR,f.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],f.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(f.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,f.iridescenceMapTransform)),h.iridescenceThicknessMap&&(f.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,f.iridescenceThicknessMapTransform))),h.transmission>0&&(f.transmission.value=h.transmission,f.transmissionSamplerMap.value=M.texture,f.transmissionSamplerSize.value.set(M.width,M.height),h.transmissionMap&&(f.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,f.transmissionMapTransform)),f.thickness.value=h.thickness,h.thicknessMap&&(f.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,f.thicknessMapTransform)),f.attenuationDistance.value=h.attenuationDistance,f.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(f.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(f.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,f.anisotropyMapTransform))),f.specularIntensity.value=h.specularIntensity,f.specularColor.value.copy(h.specularColor),h.specularColorMap&&(f.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,f.specularColorMapTransform)),h.specularIntensityMap&&(f.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,f.specularIntensityMapTransform))}function _(f,h){h.matcap&&(f.matcap.value=h.matcap)}function S(f,h){const M=e.get(h).light;f.referencePosition.value.setFromMatrixPosition(M.matrixWorld),f.nearDistance.value=M.shadow.camera.near,f.farDistance.value=M.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Ag(i,e,t,n){let r={},a={},s=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,b){const E=b.program;n.uniformBlockBinding(M,E)}function c(M,b){let E=r[M.id];E===void 0&&(_(M),E=d(M),r[M.id]=E,M.addEventListener("dispose",f));const R=b.program;n.updateUBOMapping(M,R);const A=e.render.frame;a[M.id]!==A&&(u(M),a[M.id]=A)}function d(M){const b=p();M.__bindingPointIndex=b;const E=i.createBuffer(),R=M.__size,A=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,R,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,E),E}function p(){for(let M=0;M<o;M++)if(s.indexOf(M)===-1)return s.push(M),M;return He("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(M){const b=r[M.id],E=M.uniforms,R=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let A=0,D=E.length;A<D;A++){const x=Array.isArray(E[A])?E[A]:[E[A]];for(let y=0,q=x.length;y<q;y++){const w=x[y];if(m(w,A,y,R)===!0){const G=w.__offset,B=Array.isArray(w.value)?w.value:[w.value];let k=0;for(let V=0;V<B.length;V++){const z=B[V],O=S(z);typeof z=="number"||typeof z=="boolean"?(w.__data[0]=z,i.bufferSubData(i.UNIFORM_BUFFER,G+k,w.__data)):z.isMatrix3?(w.__data[0]=z.elements[0],w.__data[1]=z.elements[1],w.__data[2]=z.elements[2],w.__data[3]=0,w.__data[4]=z.elements[3],w.__data[5]=z.elements[4],w.__data[6]=z.elements[5],w.__data[7]=0,w.__data[8]=z.elements[6],w.__data[9]=z.elements[7],w.__data[10]=z.elements[8],w.__data[11]=0):(z.toArray(w.__data,k),k+=O.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,G,w.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(M,b,E,R){const A=M.value,D=b+"_"+E;if(R[D]===void 0)return typeof A=="number"||typeof A=="boolean"?R[D]=A:R[D]=A.clone(),!0;{const x=R[D];if(typeof A=="number"||typeof A=="boolean"){if(x!==A)return R[D]=A,!0}else if(x.equals(A)===!1)return x.copy(A),!0}return!1}function _(M){const b=M.uniforms;let E=0;const R=16;for(let D=0,x=b.length;D<x;D++){const y=Array.isArray(b[D])?b[D]:[b[D]];for(let q=0,w=y.length;q<w;q++){const G=y[q],B=Array.isArray(G.value)?G.value:[G.value];for(let k=0,V=B.length;k<V;k++){const z=B[k],O=S(z),Q=E%R,K=Q%O.boundary,ce=Q+K;E+=K,ce!==0&&R-ce<O.storage&&(E+=R-ce),G.__data=new Float32Array(O.storage/Float32Array.BYTES_PER_ELEMENT),G.__offset=E,E+=O.storage}}}const A=E%R;return A>0&&(E+=R-A),M.__size=E,M.__cache={},this}function S(M){const b={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(b.boundary=4,b.storage=4):M.isVector2?(b.boundary=8,b.storage=8):M.isVector3||M.isColor?(b.boundary=16,b.storage=12):M.isVector4?(b.boundary=16,b.storage=16):M.isMatrix3?(b.boundary=48,b.storage=48):M.isMatrix4?(b.boundary=64,b.storage=64):M.isTexture?Re("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Re("WebGLRenderer: Unsupported uniform value type.",M),b}function f(M){const b=M.target;b.removeEventListener("dispose",f);const E=s.indexOf(b.__bindingPointIndex);s.splice(E,1),i.deleteBuffer(r[b.id]),delete r[b.id],delete a[b.id]}function h(){for(const M in r)i.deleteBuffer(r[M]);s=[],r={},a={}}return{bind:l,update:c,dispose:h}}const Cg=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let nn=null;function wg(){return nn===null&&(nn=new tr(Cg,16,16,Di,bn),nn.name="DFG_LUT",nn.minFilter=pt,nn.magFilter=pt,nn.wrapS=yt,nn.wrapT=yt,nn.generateMipmaps=!1,nn.needsUpdate=!0),nn}class Rg{constructor(e={}){const{canvas:t=qu(),context:n=null,depth:r=!0,stencil:a=!1,alpha:s=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:m=Gt}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=s;const S=m,f=new Set([ro,io,no]),h=new Set([Gt,ln,Ki,Ji,Qs,eo]),M=new Uint32Array(4),b=new Int32Array(4);let E=null,R=null;const A=[],D=[];let x=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=on,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const y=this;let q=!1;this._outputColorSpace=Bt;let w=0,G=0,B=null,k=-1,V=null;const z=new ht,O=new ht;let Q=null;const K=new Ge(0);let ce=0,fe=t.width,ue=t.height,De=1,et=null,Ye=null;const $=new ht(0,0,fe,ue),j=new ht(0,0,fe,ue);let J=!1;const me=new hc;let Ae=!1,ye=!1;const vt=new qe,Ve=new U,$e=new ht,tt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ne=!1;function lt(){return B===null?De:1}let C=n;function dt(v,I){return t.getContext(v,I)}try{const v={alpha:!0,depth:r,stencil:a,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ks}`),t.addEventListener("webglcontextlost",xe,!1),t.addEventListener("webglcontextrestored",Pe,!1),t.addEventListener("webglcontextcreationerror",rt,!1),C===null){const I="webgl2";if(C=dt(I,v),C===null)throw dt(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw He("WebGLRenderer: "+v.message),v}let Xe,it,Me,T,g,L,Y,Z,X,ge,re,Ce,we,ee,ne,_e,ve,he,Oe,P,ae,ie,pe;function te(){Xe=new Rp(C),Xe.init(),ae=new vg(C,Xe),it=new Mp(C,Xe,e,ae),Me=new _g(C,Xe),it.reversedDepthBuffer&&u&&Me.buffers.depth.setReversed(!0),T=new Lp(C),g=new ig,L=new xg(C,Xe,Me,g,it,ae,T),Y=new wp(y),Z=new Nh(C),ie=new vp(C,Z),X=new Pp(C,Z,T,ie),ge=new Up(C,X,Z,ie,T),he=new Ip(C,it,L),ne=new Tp(g),re=new ng(y,Y,Xe,it,ie,ne),Ce=new bg(y,g),we=new ag,ee=new hg(Xe),ve=new xp(y,Y,Me,ge,_,l),_e=new gg(y,ge,it),pe=new Ag(C,T,it,Me),Oe=new Sp(C,Xe,T),P=new Dp(C,Xe,T),T.programs=re.programs,y.capabilities=it,y.extensions=Xe,y.properties=g,y.renderLists=we,y.shadowMap=_e,y.state=Me,y.info=T}te(),S!==Gt&&(x=new Np(S,t.width,t.height,r,a));const W=new yg(y,C);this.xr=W,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const v=Xe.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Xe.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return De},this.setPixelRatio=function(v){v!==void 0&&(De=v,this.setSize(fe,ue,!1))},this.getSize=function(v){return v.set(fe,ue)},this.setSize=function(v,I,H=!0){if(W.isPresenting){Re("WebGLRenderer: Can't change size while VR device is presenting.");return}fe=v,ue=I,t.width=Math.floor(v*De),t.height=Math.floor(I*De),H===!0&&(t.style.width=v+"px",t.style.height=I+"px"),x!==null&&x.setSize(t.width,t.height),this.setViewport(0,0,v,I)},this.getDrawingBufferSize=function(v){return v.set(fe*De,ue*De).floor()},this.setDrawingBufferSize=function(v,I,H){fe=v,ue=I,De=H,t.width=Math.floor(v*H),t.height=Math.floor(I*H),this.setViewport(0,0,v,I)},this.setEffects=function(v){if(S===Gt){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let I=0;I<v.length;I++)if(v[I].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}x.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(z)},this.getViewport=function(v){return v.copy($)},this.setViewport=function(v,I,H,N){v.isVector4?$.set(v.x,v.y,v.z,v.w):$.set(v,I,H,N),Me.viewport(z.copy($).multiplyScalar(De).round())},this.getScissor=function(v){return v.copy(j)},this.setScissor=function(v,I,H,N){v.isVector4?j.set(v.x,v.y,v.z,v.w):j.set(v,I,H,N),Me.scissor(O.copy(j).multiplyScalar(De).round())},this.getScissorTest=function(){return J},this.setScissorTest=function(v){Me.setScissorTest(J=v)},this.setOpaqueSort=function(v){et=v},this.setTransparentSort=function(v){Ye=v},this.getClearColor=function(v){return v.copy(ve.getClearColor())},this.setClearColor=function(){ve.setClearColor(...arguments)},this.getClearAlpha=function(){return ve.getClearAlpha()},this.setClearAlpha=function(){ve.setClearAlpha(...arguments)},this.clear=function(v=!0,I=!0,H=!0){let N=0;if(v){let F=!1;if(B!==null){const oe=B.texture.format;F=f.has(oe)}if(F){const oe=B.texture.type,de=h.has(oe),le=ve.getClearColor(),Se=ve.getClearAlpha(),Ee=le.r,Le=le.g,Be=le.b;de?(M[0]=Ee,M[1]=Le,M[2]=Be,M[3]=Se,C.clearBufferuiv(C.COLOR,0,M)):(b[0]=Ee,b[1]=Le,b[2]=Be,b[3]=Se,C.clearBufferiv(C.COLOR,0,b))}else N|=C.COLOR_BUFFER_BIT}I&&(N|=C.DEPTH_BUFFER_BIT),H&&(N|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),N!==0&&C.clear(N)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",xe,!1),t.removeEventListener("webglcontextrestored",Pe,!1),t.removeEventListener("webglcontextcreationerror",rt,!1),ve.dispose(),we.dispose(),ee.dispose(),g.dispose(),Y.dispose(),ge.dispose(),ie.dispose(),pe.dispose(),re.dispose(),W.dispose(),W.removeEventListener("sessionstart",To),W.removeEventListener("sessionend",yo),Hn.stop()};function xe(v){v.preventDefault(),Oo("WebGLRenderer: Context Lost."),q=!0}function Pe(){Oo("WebGLRenderer: Context Restored."),q=!1;const v=T.autoReset,I=_e.enabled,H=_e.autoUpdate,N=_e.needsUpdate,F=_e.type;te(),T.autoReset=v,_e.enabled=I,_e.autoUpdate=H,_e.needsUpdate=N,_e.type=F}function rt(v){He("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function je(v){const I=v.target;I.removeEventListener("dispose",je),dn(I)}function dn(v){fn(v),g.remove(v)}function fn(v){const I=g.get(v).programs;I!==void 0&&(I.forEach(function(H){re.releaseProgram(H)}),v.isShaderMaterial&&re.releaseShaderCache(v))}this.renderBufferDirect=function(v,I,H,N,F,oe){I===null&&(I=tt);const de=F.isMesh&&F.matrixWorld.determinant()<0,le=qc(v,I,H,N,F);Me.setMaterial(N,de);let Se=H.index,Ee=1;if(N.wireframe===!0){if(Se=X.getWireframeAttribute(H),Se===void 0)return;Ee=2}const Le=H.drawRange,Be=H.attributes.position;let be=Le.start*Ee,Ke=(Le.start+Le.count)*Ee;oe!==null&&(be=Math.max(be,oe.start*Ee),Ke=Math.min(Ke,(oe.start+oe.count)*Ee)),Se!==null?(be=Math.max(be,0),Ke=Math.min(Ke,Se.count)):Be!=null&&(be=Math.max(be,0),Ke=Math.min(Ke,Be.count));const ct=Ke-be;if(ct<0||ct===1/0)return;ie.setup(F,N,le,H,Se);let ot,Je=Oe;if(Se!==null&&(ot=Z.get(Se),Je=P,Je.setIndex(ot)),F.isMesh)N.wireframe===!0?(Me.setLineWidth(N.wireframeLinewidth*lt()),Je.setMode(C.LINES)):Je.setMode(C.TRIANGLES);else if(F.isLine){let Et=N.linewidth;Et===void 0&&(Et=1),Me.setLineWidth(Et*lt()),F.isLineSegments?Je.setMode(C.LINES):F.isLineLoop?Je.setMode(C.LINE_LOOP):Je.setMode(C.LINE_STRIP)}else F.isPoints?Je.setMode(C.POINTS):F.isSprite&&Je.setMode(C.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)Wr("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Je.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(Xe.get("WEBGL_multi_draw"))Je.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const Et=F._multiDrawStarts,Te=F._multiDrawCounts,Ft=F._multiDrawCount,We=Se?Z.get(Se).bytesPerElement:1,Xt=g.get(N).currentProgram.getUniforms();for(let en=0;en<Ft;en++)Xt.setValue(C,"_gl_DrawID",en),Je.render(Et[en]/We,Te[en])}else if(F.isInstancedMesh)Je.renderInstances(be,ct,F.count);else if(H.isInstancedBufferGeometry){const Et=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,Te=Math.min(H.instanceCount,Et);Je.renderInstances(be,ct,Te)}else Je.render(be,ct)};function Mo(v,I,H){v.transparent===!0&&v.side===Zt&&v.forceSinglePass===!1?(v.side=Lt,v.needsUpdate=!0,rr(v,I,H),v.side=Vn,v.needsUpdate=!0,rr(v,I,H),v.side=Zt):rr(v,I,H)}this.compile=function(v,I,H=null){H===null&&(H=v),R=ee.get(H),R.init(I),D.push(R),H.traverseVisible(function(F){F.isLight&&F.layers.test(I.layers)&&(R.pushLight(F),F.castShadow&&R.pushShadow(F))}),v!==H&&v.traverseVisible(function(F){F.isLight&&F.layers.test(I.layers)&&(R.pushLight(F),F.castShadow&&R.pushShadow(F))}),R.setupLights();const N=new Set;return v.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;const oe=F.material;if(oe)if(Array.isArray(oe))for(let de=0;de<oe.length;de++){const le=oe[de];Mo(le,H,F),N.add(le)}else Mo(oe,H,F),N.add(oe)}),R=D.pop(),N},this.compileAsync=function(v,I,H=null){const N=this.compile(v,I,H);return new Promise(F=>{function oe(){if(N.forEach(function(de){g.get(de).currentProgram.isReady()&&N.delete(de)}),N.size===0){F(v);return}setTimeout(oe,10)}Xe.get("KHR_parallel_shader_compile")!==null?oe():setTimeout(oe,10)})};let fa=null;function Xc(v){fa&&fa(v)}function To(){Hn.stop()}function yo(){Hn.start()}const Hn=new gc;Hn.setAnimationLoop(Xc),typeof self<"u"&&Hn.setContext(self),this.setAnimationLoop=function(v){fa=v,W.setAnimationLoop(v),v===null?Hn.stop():Hn.start()},W.addEventListener("sessionstart",To),W.addEventListener("sessionend",yo),this.render=function(v,I){if(I!==void 0&&I.isCamera!==!0){He("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(q===!0)return;const H=W.enabled===!0&&W.isPresenting===!0,N=x!==null&&(B===null||H)&&x.begin(y,B);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),W.enabled===!0&&W.isPresenting===!0&&(x===null||x.isCompositing()===!1)&&(W.cameraAutoUpdate===!0&&W.updateCamera(I),I=W.getCamera()),v.isScene===!0&&v.onBeforeRender(y,v,I,B),R=ee.get(v,D.length),R.init(I),D.push(R),vt.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),me.setFromProjectionMatrix(vt,sn,I.reversedDepth),ye=this.localClippingEnabled,Ae=ne.init(this.clippingPlanes,ye),E=we.get(v,A.length),E.init(),A.push(E),W.enabled===!0&&W.isPresenting===!0){const de=y.xr.getDepthSensingMesh();de!==null&&pa(de,I,-1/0,y.sortObjects)}pa(v,I,0,y.sortObjects),E.finish(),y.sortObjects===!0&&E.sort(et,Ye),Ne=W.enabled===!1||W.isPresenting===!1||W.hasDepthSensing()===!1,Ne&&ve.addToRenderList(E,v),this.info.render.frame++,Ae===!0&&ne.beginShadows();const F=R.state.shadowsArray;if(_e.render(F,v,I),Ae===!0&&ne.endShadows(),this.info.autoReset===!0&&this.info.reset(),(N&&x.hasRenderPass())===!1){const de=E.opaque,le=E.transmissive;if(R.setupLights(),I.isArrayCamera){const Se=I.cameras;if(le.length>0)for(let Ee=0,Le=Se.length;Ee<Le;Ee++){const Be=Se[Ee];bo(de,le,v,Be)}Ne&&ve.render(v);for(let Ee=0,Le=Se.length;Ee<Le;Ee++){const Be=Se[Ee];Eo(E,v,Be,Be.viewport)}}else le.length>0&&bo(de,le,v,I),Ne&&ve.render(v),Eo(E,v,I)}B!==null&&G===0&&(L.updateMultisampleRenderTarget(B),L.updateRenderTargetMipmap(B)),N&&x.end(y),v.isScene===!0&&v.onAfterRender(y,v,I),ie.resetDefaultState(),k=-1,V=null,D.pop(),D.length>0?(R=D[D.length-1],Ae===!0&&ne.setGlobalState(y.clippingPlanes,R.state.camera)):R=null,A.pop(),A.length>0?E=A[A.length-1]:E=null};function pa(v,I,H,N){if(v.visible===!1)return;if(v.layers.test(I.layers)){if(v.isGroup)H=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(I);else if(v.isLight)R.pushLight(v),v.castShadow&&R.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||me.intersectsSprite(v)){N&&$e.setFromMatrixPosition(v.matrixWorld).applyMatrix4(vt);const de=ge.update(v),le=v.material;le.visible&&E.push(v,de,le,H,$e.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||me.intersectsObject(v))){const de=ge.update(v),le=v.material;if(N&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),$e.copy(v.boundingSphere.center)):(de.boundingSphere===null&&de.computeBoundingSphere(),$e.copy(de.boundingSphere.center)),$e.applyMatrix4(v.matrixWorld).applyMatrix4(vt)),Array.isArray(le)){const Se=de.groups;for(let Ee=0,Le=Se.length;Ee<Le;Ee++){const Be=Se[Ee],be=le[Be.materialIndex];be&&be.visible&&E.push(v,de,be,H,$e.z,Be)}}else le.visible&&E.push(v,de,le,H,$e.z,null)}}const oe=v.children;for(let de=0,le=oe.length;de<le;de++)pa(oe[de],I,H,N)}function Eo(v,I,H,N){const{opaque:F,transmissive:oe,transparent:de}=v;R.setupLightsView(H),Ae===!0&&ne.setGlobalState(y.clippingPlanes,H),N&&Me.viewport(z.copy(N)),F.length>0&&ir(F,I,H),oe.length>0&&ir(oe,I,H),de.length>0&&ir(de,I,H),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function bo(v,I,H,N){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;if(R.state.transmissionRenderTarget[N.id]===void 0){const be=Xe.has("EXT_color_buffer_half_float")||Xe.has("EXT_color_buffer_float");R.state.transmissionRenderTarget[N.id]=new Jt(1,1,{generateMipmaps:!0,type:be?bn:Gt,minFilter:Sn,samples:it.samples,stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ke.workingColorSpace})}const oe=R.state.transmissionRenderTarget[N.id],de=N.viewport||z;oe.setSize(de.z*y.transmissionResolutionScale,de.w*y.transmissionResolutionScale);const le=y.getRenderTarget(),Se=y.getActiveCubeFace(),Ee=y.getActiveMipmapLevel();y.setRenderTarget(oe),y.getClearColor(K),ce=y.getClearAlpha(),ce<1&&y.setClearColor(16777215,.5),y.clear(),Ne&&ve.render(H);const Le=y.toneMapping;y.toneMapping=on;const Be=N.viewport;if(N.viewport!==void 0&&(N.viewport=void 0),R.setupLightsView(N),Ae===!0&&ne.setGlobalState(y.clippingPlanes,N),ir(v,H,N),L.updateMultisampleRenderTarget(oe),L.updateRenderTargetMipmap(oe),Xe.has("WEBGL_multisampled_render_to_texture")===!1){let be=!1;for(let Ke=0,ct=I.length;Ke<ct;Ke++){const ot=I[Ke],{object:Je,geometry:Et,material:Te,group:Ft}=ot;if(Te.side===Zt&&Je.layers.test(N.layers)){const We=Te.side;Te.side=Lt,Te.needsUpdate=!0,Ao(Je,H,N,Et,Te,Ft),Te.side=We,Te.needsUpdate=!0,be=!0}}be===!0&&(L.updateMultisampleRenderTarget(oe),L.updateRenderTargetMipmap(oe))}y.setRenderTarget(le,Se,Ee),y.setClearColor(K,ce),Be!==void 0&&(N.viewport=Be),y.toneMapping=Le}function ir(v,I,H){const N=I.isScene===!0?I.overrideMaterial:null;for(let F=0,oe=v.length;F<oe;F++){const de=v[F],{object:le,geometry:Se,group:Ee}=de;let Le=de.material;Le.allowOverride===!0&&N!==null&&(Le=N),le.layers.test(H.layers)&&Ao(le,I,H,Se,Le,Ee)}}function Ao(v,I,H,N,F,oe){v.onBeforeRender(y,I,H,N,F,oe),v.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),F.onBeforeRender(y,I,H,N,v,oe),F.transparent===!0&&F.side===Zt&&F.forceSinglePass===!1?(F.side=Lt,F.needsUpdate=!0,y.renderBufferDirect(H,I,N,F,v,oe),F.side=Vn,F.needsUpdate=!0,y.renderBufferDirect(H,I,N,F,v,oe),F.side=Zt):y.renderBufferDirect(H,I,N,F,v,oe),v.onAfterRender(y,I,H,N,F,oe)}function rr(v,I,H){I.isScene!==!0&&(I=tt);const N=g.get(v),F=R.state.lights,oe=R.state.shadowsArray,de=F.state.version,le=re.getParameters(v,F.state,oe,I,H),Se=re.getProgramCacheKey(le);let Ee=N.programs;N.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?I.environment:null,N.fog=I.fog;const Le=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;N.envMap=Y.get(v.envMap||N.environment,Le),N.envMapRotation=N.environment!==null&&v.envMap===null?I.environmentRotation:v.envMapRotation,Ee===void 0&&(v.addEventListener("dispose",je),Ee=new Map,N.programs=Ee);let Be=Ee.get(Se);if(Be!==void 0){if(N.currentProgram===Be&&N.lightsStateVersion===de)return wo(v,le),Be}else le.uniforms=re.getUniforms(v),v.onBeforeCompile(le,y),Be=re.acquireProgram(le,Se),Ee.set(Se,Be),N.uniforms=le.uniforms;const be=N.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(be.clippingPlanes=ne.uniform),wo(v,le),N.needsLights=$c(v),N.lightsStateVersion=de,N.needsLights&&(be.ambientLightColor.value=F.state.ambient,be.lightProbe.value=F.state.probe,be.directionalLights.value=F.state.directional,be.directionalLightShadows.value=F.state.directionalShadow,be.spotLights.value=F.state.spot,be.spotLightShadows.value=F.state.spotShadow,be.rectAreaLights.value=F.state.rectArea,be.ltc_1.value=F.state.rectAreaLTC1,be.ltc_2.value=F.state.rectAreaLTC2,be.pointLights.value=F.state.point,be.pointLightShadows.value=F.state.pointShadow,be.hemisphereLights.value=F.state.hemi,be.directionalShadowMatrix.value=F.state.directionalShadowMatrix,be.spotLightMatrix.value=F.state.spotLightMatrix,be.spotLightMap.value=F.state.spotLightMap,be.pointShadowMatrix.value=F.state.pointShadowMatrix),N.currentProgram=Be,N.uniformsList=null,Be}function Co(v){if(v.uniformsList===null){const I=v.currentProgram.getUniforms();v.uniformsList=Gr.seqWithValue(I.seq,v.uniforms)}return v.uniformsList}function wo(v,I){const H=g.get(v);H.outputColorSpace=I.outputColorSpace,H.batching=I.batching,H.batchingColor=I.batchingColor,H.instancing=I.instancing,H.instancingColor=I.instancingColor,H.instancingMorph=I.instancingMorph,H.skinning=I.skinning,H.morphTargets=I.morphTargets,H.morphNormals=I.morphNormals,H.morphColors=I.morphColors,H.morphTargetsCount=I.morphTargetsCount,H.numClippingPlanes=I.numClippingPlanes,H.numIntersection=I.numClipIntersection,H.vertexAlphas=I.vertexAlphas,H.vertexTangents=I.vertexTangents,H.toneMapping=I.toneMapping}function qc(v,I,H,N,F){I.isScene!==!0&&(I=tt),L.resetTextureUnits();const oe=I.fog,de=N.isMeshStandardMaterial||N.isMeshLambertMaterial||N.isMeshPhongMaterial?I.environment:null,le=B===null?y.outputColorSpace:B.isXRRenderTarget===!0?B.texture.colorSpace:Li,Se=N.isMeshStandardMaterial||N.isMeshLambertMaterial&&!N.envMap||N.isMeshPhongMaterial&&!N.envMap,Ee=Y.get(N.envMap||de,Se),Le=N.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,Be=!!H.attributes.tangent&&(!!N.normalMap||N.anisotropy>0),be=!!H.morphAttributes.position,Ke=!!H.morphAttributes.normal,ct=!!H.morphAttributes.color;let ot=on;N.toneMapped&&(B===null||B.isXRRenderTarget===!0)&&(ot=y.toneMapping);const Je=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,Et=Je!==void 0?Je.length:0,Te=g.get(N),Ft=R.state.lights;if(Ae===!0&&(ye===!0||v!==V)){const St=v===V&&N.id===k;ne.setState(N,v,St)}let We=!1;N.version===Te.__version?(Te.needsLights&&Te.lightsStateVersion!==Ft.state.version||Te.outputColorSpace!==le||F.isBatchedMesh&&Te.batching===!1||!F.isBatchedMesh&&Te.batching===!0||F.isBatchedMesh&&Te.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Te.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Te.instancing===!1||!F.isInstancedMesh&&Te.instancing===!0||F.isSkinnedMesh&&Te.skinning===!1||!F.isSkinnedMesh&&Te.skinning===!0||F.isInstancedMesh&&Te.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Te.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Te.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Te.instancingMorph===!1&&F.morphTexture!==null||Te.envMap!==Ee||N.fog===!0&&Te.fog!==oe||Te.numClippingPlanes!==void 0&&(Te.numClippingPlanes!==ne.numPlanes||Te.numIntersection!==ne.numIntersection)||Te.vertexAlphas!==Le||Te.vertexTangents!==Be||Te.morphTargets!==be||Te.morphNormals!==Ke||Te.morphColors!==ct||Te.toneMapping!==ot||Te.morphTargetsCount!==Et)&&(We=!0):(We=!0,Te.__version=N.version);let Xt=Te.currentProgram;We===!0&&(Xt=rr(N,I,F));let en=!1,kn=!1,si=!1;const nt=Xt.getUniforms(),Tt=Te.uniforms;if(Me.useProgram(Xt.program)&&(en=!0,kn=!0,si=!0),N.id!==k&&(k=N.id,kn=!0),en||V!==v){Me.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),nt.setValue(C,"projectionMatrix",v.projectionMatrix),nt.setValue(C,"viewMatrix",v.matrixWorldInverse);const Pn=nt.map.cameraPosition;Pn!==void 0&&Pn.setValue(C,Ve.setFromMatrixPosition(v.matrixWorld)),it.logarithmicDepthBuffer&&nt.setValue(C,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(N.isMeshPhongMaterial||N.isMeshToonMaterial||N.isMeshLambertMaterial||N.isMeshBasicMaterial||N.isMeshStandardMaterial||N.isShaderMaterial)&&nt.setValue(C,"isOrthographic",v.isOrthographicCamera===!0),V!==v&&(V=v,kn=!0,si=!0)}if(Te.needsLights&&(Ft.state.directionalShadowMap.length>0&&nt.setValue(C,"directionalShadowMap",Ft.state.directionalShadowMap,L),Ft.state.spotShadowMap.length>0&&nt.setValue(C,"spotShadowMap",Ft.state.spotShadowMap,L),Ft.state.pointShadowMap.length>0&&nt.setValue(C,"pointShadowMap",Ft.state.pointShadowMap,L)),F.isSkinnedMesh){nt.setOptional(C,F,"bindMatrix"),nt.setOptional(C,F,"bindMatrixInverse");const St=F.skeleton;St&&(St.boneTexture===null&&St.computeBoneTexture(),nt.setValue(C,"boneTexture",St.boneTexture,L))}F.isBatchedMesh&&(nt.setOptional(C,F,"batchingTexture"),nt.setValue(C,"batchingTexture",F._matricesTexture,L),nt.setOptional(C,F,"batchingIdTexture"),nt.setValue(C,"batchingIdTexture",F._indirectTexture,L),nt.setOptional(C,F,"batchingColorTexture"),F._colorsTexture!==null&&nt.setValue(C,"batchingColorTexture",F._colorsTexture,L));const Rn=H.morphAttributes;if((Rn.position!==void 0||Rn.normal!==void 0||Rn.color!==void 0)&&he.update(F,H,Xt),(kn||Te.receiveShadow!==F.receiveShadow)&&(Te.receiveShadow=F.receiveShadow,nt.setValue(C,"receiveShadow",F.receiveShadow)),(N.isMeshStandardMaterial||N.isMeshLambertMaterial||N.isMeshPhongMaterial)&&N.envMap===null&&I.environment!==null&&(Tt.envMapIntensity.value=I.environmentIntensity),Tt.dfgLUT!==void 0&&(Tt.dfgLUT.value=wg()),kn&&(nt.setValue(C,"toneMappingExposure",y.toneMappingExposure),Te.needsLights&&Yc(Tt,si),oe&&N.fog===!0&&Ce.refreshFogUniforms(Tt,oe),Ce.refreshMaterialUniforms(Tt,N,De,ue,R.state.transmissionRenderTarget[v.id]),Gr.upload(C,Co(Te),Tt,L)),N.isShaderMaterial&&N.uniformsNeedUpdate===!0&&(Gr.upload(C,Co(Te),Tt,L),N.uniformsNeedUpdate=!1),N.isSpriteMaterial&&nt.setValue(C,"center",F.center),nt.setValue(C,"modelViewMatrix",F.modelViewMatrix),nt.setValue(C,"normalMatrix",F.normalMatrix),nt.setValue(C,"modelMatrix",F.matrixWorld),N.isShaderMaterial||N.isRawShaderMaterial){const St=N.uniformsGroups;for(let Pn=0,oi=St.length;Pn<oi;Pn++){const Ro=St[Pn];pe.update(Ro,Xt),pe.bind(Ro,Xt)}}return Xt}function Yc(v,I){v.ambientLightColor.needsUpdate=I,v.lightProbe.needsUpdate=I,v.directionalLights.needsUpdate=I,v.directionalLightShadows.needsUpdate=I,v.pointLights.needsUpdate=I,v.pointLightShadows.needsUpdate=I,v.spotLights.needsUpdate=I,v.spotLightShadows.needsUpdate=I,v.rectAreaLights.needsUpdate=I,v.hemisphereLights.needsUpdate=I}function $c(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return G},this.getRenderTarget=function(){return B},this.setRenderTargetTextures=function(v,I,H){const N=g.get(v);N.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,N.__autoAllocateDepthBuffer===!1&&(N.__useRenderToTexture=!1),g.get(v.texture).__webglTexture=I,g.get(v.depthTexture).__webglTexture=N.__autoAllocateDepthBuffer?void 0:H,N.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,I){const H=g.get(v);H.__webglFramebuffer=I,H.__useDefaultFramebuffer=I===void 0};const jc=C.createFramebuffer();this.setRenderTarget=function(v,I=0,H=0){B=v,w=I,G=H;let N=null,F=!1,oe=!1;if(v){const le=g.get(v);if(le.__useDefaultFramebuffer!==void 0){Me.bindFramebuffer(C.FRAMEBUFFER,le.__webglFramebuffer),z.copy(v.viewport),O.copy(v.scissor),Q=v.scissorTest,Me.viewport(z),Me.scissor(O),Me.setScissorTest(Q),k=-1;return}else if(le.__webglFramebuffer===void 0)L.setupRenderTarget(v);else if(le.__hasExternalTextures)L.rebindTextures(v,g.get(v.texture).__webglTexture,g.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Le=v.depthTexture;if(le.__boundDepthTexture!==Le){if(Le!==null&&g.has(Le)&&(v.width!==Le.image.width||v.height!==Le.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");L.setupDepthRenderbuffer(v)}}const Se=v.texture;(Se.isData3DTexture||Se.isDataArrayTexture||Se.isCompressedArrayTexture)&&(oe=!0);const Ee=g.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Ee[I])?N=Ee[I][H]:N=Ee[I],F=!0):v.samples>0&&L.useMultisampledRTT(v)===!1?N=g.get(v).__webglMultisampledFramebuffer:Array.isArray(Ee)?N=Ee[H]:N=Ee,z.copy(v.viewport),O.copy(v.scissor),Q=v.scissorTest}else z.copy($).multiplyScalar(De).floor(),O.copy(j).multiplyScalar(De).floor(),Q=J;if(H!==0&&(N=jc),Me.bindFramebuffer(C.FRAMEBUFFER,N)&&Me.drawBuffers(v,N),Me.viewport(z),Me.scissor(O),Me.setScissorTest(Q),F){const le=g.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+I,le.__webglTexture,H)}else if(oe){const le=I;for(let Se=0;Se<v.textures.length;Se++){const Ee=g.get(v.textures[Se]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+Se,Ee.__webglTexture,H,le)}}else if(v!==null&&H!==0){const le=g.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,le.__webglTexture,H)}k=-1},this.readRenderTargetPixels=function(v,I,H,N,F,oe,de,le=0){if(!(v&&v.isWebGLRenderTarget)){He("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Se=g.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&de!==void 0&&(Se=Se[de]),Se){Me.bindFramebuffer(C.FRAMEBUFFER,Se);try{const Ee=v.textures[le],Le=Ee.format,Be=Ee.type;if(v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+le),!it.textureFormatReadable(Le)){He("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!it.textureTypeReadable(Be)){He("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=v.width-N&&H>=0&&H<=v.height-F&&C.readPixels(I,H,N,F,ae.convert(Le),ae.convert(Be),oe)}finally{const Ee=B!==null?g.get(B).__webglFramebuffer:null;Me.bindFramebuffer(C.FRAMEBUFFER,Ee)}}},this.readRenderTargetPixelsAsync=async function(v,I,H,N,F,oe,de,le=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Se=g.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&de!==void 0&&(Se=Se[de]),Se)if(I>=0&&I<=v.width-N&&H>=0&&H<=v.height-F){Me.bindFramebuffer(C.FRAMEBUFFER,Se);const Ee=v.textures[le],Le=Ee.format,Be=Ee.type;if(v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+le),!it.textureFormatReadable(Le))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!it.textureTypeReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const be=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,be),C.bufferData(C.PIXEL_PACK_BUFFER,oe.byteLength,C.STREAM_READ),C.readPixels(I,H,N,F,ae.convert(Le),ae.convert(Be),0);const Ke=B!==null?g.get(B).__webglFramebuffer:null;Me.bindFramebuffer(C.FRAMEBUFFER,Ke);const ct=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await Yu(C,ct,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,be),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,oe),C.deleteBuffer(be),C.deleteSync(ct),oe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,I=null,H=0){const N=Math.pow(2,-H),F=Math.floor(v.image.width*N),oe=Math.floor(v.image.height*N),de=I!==null?I.x:0,le=I!==null?I.y:0;L.setTexture2D(v,0),C.copyTexSubImage2D(C.TEXTURE_2D,H,0,0,de,le,F,oe),Me.unbindTexture()};const Zc=C.createFramebuffer(),Kc=C.createFramebuffer();this.copyTextureToTexture=function(v,I,H=null,N=null,F=0,oe=0){let de,le,Se,Ee,Le,Be,be,Ke,ct;const ot=v.isCompressedTexture?v.mipmaps[oe]:v.image;if(H!==null)de=H.max.x-H.min.x,le=H.max.y-H.min.y,Se=H.isBox3?H.max.z-H.min.z:1,Ee=H.min.x,Le=H.min.y,Be=H.isBox3?H.min.z:0;else{const Tt=Math.pow(2,-F);de=Math.floor(ot.width*Tt),le=Math.floor(ot.height*Tt),v.isDataArrayTexture?Se=ot.depth:v.isData3DTexture?Se=Math.floor(ot.depth*Tt):Se=1,Ee=0,Le=0,Be=0}N!==null?(be=N.x,Ke=N.y,ct=N.z):(be=0,Ke=0,ct=0);const Je=ae.convert(I.format),Et=ae.convert(I.type);let Te;I.isData3DTexture?(L.setTexture3D(I,0),Te=C.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(L.setTexture2DArray(I,0),Te=C.TEXTURE_2D_ARRAY):(L.setTexture2D(I,0),Te=C.TEXTURE_2D),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,I.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,I.unpackAlignment);const Ft=C.getParameter(C.UNPACK_ROW_LENGTH),We=C.getParameter(C.UNPACK_IMAGE_HEIGHT),Xt=C.getParameter(C.UNPACK_SKIP_PIXELS),en=C.getParameter(C.UNPACK_SKIP_ROWS),kn=C.getParameter(C.UNPACK_SKIP_IMAGES);C.pixelStorei(C.UNPACK_ROW_LENGTH,ot.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,ot.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Ee),C.pixelStorei(C.UNPACK_SKIP_ROWS,Le),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Be);const si=v.isDataArrayTexture||v.isData3DTexture,nt=I.isDataArrayTexture||I.isData3DTexture;if(v.isDepthTexture){const Tt=g.get(v),Rn=g.get(I),St=g.get(Tt.__renderTarget),Pn=g.get(Rn.__renderTarget);Me.bindFramebuffer(C.READ_FRAMEBUFFER,St.__webglFramebuffer),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,Pn.__webglFramebuffer);for(let oi=0;oi<Se;oi++)si&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,g.get(v).__webglTexture,F,Be+oi),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,g.get(I).__webglTexture,oe,ct+oi)),C.blitFramebuffer(Ee,Le,de,le,be,Ke,de,le,C.DEPTH_BUFFER_BIT,C.NEAREST);Me.bindFramebuffer(C.READ_FRAMEBUFFER,null),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(F!==0||v.isRenderTargetTexture||g.has(v)){const Tt=g.get(v),Rn=g.get(I);Me.bindFramebuffer(C.READ_FRAMEBUFFER,Zc),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,Kc);for(let St=0;St<Se;St++)si?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Tt.__webglTexture,F,Be+St):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Tt.__webglTexture,F),nt?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Rn.__webglTexture,oe,ct+St):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Rn.__webglTexture,oe),F!==0?C.blitFramebuffer(Ee,Le,de,le,be,Ke,de,le,C.COLOR_BUFFER_BIT,C.NEAREST):nt?C.copyTexSubImage3D(Te,oe,be,Ke,ct+St,Ee,Le,de,le):C.copyTexSubImage2D(Te,oe,be,Ke,Ee,Le,de,le);Me.bindFramebuffer(C.READ_FRAMEBUFFER,null),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else nt?v.isDataTexture||v.isData3DTexture?C.texSubImage3D(Te,oe,be,Ke,ct,de,le,Se,Je,Et,ot.data):I.isCompressedArrayTexture?C.compressedTexSubImage3D(Te,oe,be,Ke,ct,de,le,Se,Je,ot.data):C.texSubImage3D(Te,oe,be,Ke,ct,de,le,Se,Je,Et,ot):v.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,oe,be,Ke,de,le,Je,Et,ot.data):v.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,oe,be,Ke,ot.width,ot.height,Je,ot.data):C.texSubImage2D(C.TEXTURE_2D,oe,be,Ke,de,le,Je,Et,ot);C.pixelStorei(C.UNPACK_ROW_LENGTH,Ft),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,We),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Xt),C.pixelStorei(C.UNPACK_SKIP_ROWS,en),C.pixelStorei(C.UNPACK_SKIP_IMAGES,kn),oe===0&&I.generateMipmaps&&C.generateMipmap(Te),Me.unbindTexture()},this.initRenderTarget=function(v){g.get(v).__webglFramebuffer===void 0&&L.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?L.setTextureCube(v,0):v.isData3DTexture?L.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?L.setTexture2DArray(v,0):L.setTexture2D(v,0),Me.unbindTexture()},this.resetState=function(){w=0,G=0,B=null,Me.reset(),ie.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return sn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=ke._getUnpackColorSpace()}}const Rl={type:"change"},uo={type:"start"},Tc={type:"end"},wr=new co,Pl=new vn,Pg=Math.cos(70*Zu.DEG2RAD),mt=new U,Pt=2*Math.PI,Qe={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Ya=1e-6;class Dg extends Uh{constructor(e,t=null){super(e,t),this.state=Qe.NONE,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Mn.ROTATE,MIDDLE:Mn.DOLLY,RIGHT:Mn.PAN},this.touches={ONE:Bn.ROTATE,TWO:Bn.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new U,this._lastQuaternion=new Cn,this._lastTargetPosition=new U,this._quat=new Cn().setFromUnitVectors(e.up,new U(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new rl,this._sphericalDelta=new rl,this._scale=1,this._panOffset=new U,this._rotateStart=new Ie,this._rotateEnd=new Ie,this._rotateDelta=new Ie,this._panStart=new Ie,this._panEnd=new Ie,this._panDelta=new Ie,this._dollyStart=new Ie,this._dollyEnd=new Ie,this._dollyDelta=new Ie,this._dollyDirection=new U,this._mouse=new Ie,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Ig.bind(this),this._onPointerDown=Lg.bind(this),this._onPointerUp=Ug.bind(this),this._onContextMenu=Vg.bind(this),this._onMouseWheel=Og.bind(this),this._onKeyDown=Bg.bind(this),this._onTouchStart=zg.bind(this),this._onTouchMove=Gg.bind(this),this._onMouseDown=Fg.bind(this),this._onMouseMove=Ng.bind(this),this._interceptControlDown=Hg.bind(this),this._interceptControlUp=kg.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e==="grab"?this.domElement.style.cursor="grab":this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Rl),this.update(),this.state=Qe.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){const t=this.object.position;mt.copy(t).sub(this.target),mt.applyQuaternion(this._quat),this._spherical.setFromVector3(mt),this.autoRotate&&this.state===Qe.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=Pt:n>Math.PI&&(n-=Pt),r<-Math.PI?r+=Pt:r>Math.PI&&(r-=Pt),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let a=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const s=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),a=s!=this._spherical.radius}if(mt.setFromSpherical(this._spherical),mt.applyQuaternion(this._quatInverse),t.copy(this.target).add(mt),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let s=null;if(this.object.isPerspectiveCamera){const o=mt.length();s=this._clampDistance(o*this._scale);const l=o-s;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),a=!!l}else if(this.object.isOrthographicCamera){const o=new U(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),a=l!==this.object.zoom;const c=new U(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),s=mt.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;s!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(s).add(this.object.position):(wr.origin.copy(this.object.position),wr.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(wr.direction))<Pg?this.object.lookAt(this.target):(Pl.setFromNormalAndCoplanarPoint(this.object.up,this.target),wr.intersectPlane(Pl,this.target))))}else if(this.object.isOrthographicCamera){const s=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),s!==this.object.zoom&&(this.object.updateProjectionMatrix(),a=!0)}return this._scale=1,this._performCursorZoom=!1,a||this._lastPosition.distanceToSquared(this.object.position)>Ya||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Ya||this._lastTargetPosition.distanceToSquared(this.target)>Ya?(this.dispatchEvent(Rl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?Pt/60*this.autoRotateSpeed*e:Pt/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){mt.setFromMatrixColumn(t,0),mt.multiplyScalar(-e),this._panOffset.add(mt)}_panUp(e,t){this.screenSpacePanning===!0?mt.setFromMatrixColumn(t,1):(mt.setFromMatrixColumn(t,0),mt.crossVectors(this.object.up,mt)),mt.multiplyScalar(e),this._panOffset.add(mt)}_pan(e,t){const n=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;mt.copy(r).sub(this.target);let a=mt.length();a*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*a/n.clientHeight,this.object.matrix),this._panUp(2*t*a/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const n=this.domElement.getBoundingClientRect(),r=e-n.left,a=t-n.top,s=n.width,o=n.height;this._mouse.x=r/s*2-1,this._mouse.y=-(a/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Pt*this._rotateDelta.x/t.clientHeight),this._rotateUp(Pt*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Pt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Pt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Pt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Pt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,a=Math.sqrt(n*n+r*r);this._dollyStart.set(0,a)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),r=.5*(e.pageX+n.x),a=.5*(e.pageY+n.y);this._rotateEnd.set(r,a)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Pt*this._rotateDelta.x/t.clientHeight),this._rotateUp(Pt*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,a=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,a),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const s=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(s,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new Ie,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}}function Lg(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i),this._cursorStyle==="grab"&&(this.domElement.style.cursor="grabbing")))}function Ig(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function Ug(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Tc),this.state=Qe.NONE,this._cursorStyle==="grab"&&(this.domElement.style.cursor="grab");break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function Fg(i){let e;switch(i.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case Mn.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=Qe.DOLLY;break;case Mn.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=Qe.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=Qe.ROTATE}break;case Mn.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=Qe.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=Qe.PAN}break;default:this.state=Qe.NONE}this.state!==Qe.NONE&&this.dispatchEvent(uo)}function Ng(i){switch(this.state){case Qe.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case Qe.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case Qe.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function Og(i){this.enabled===!1||this.enableZoom===!1||this.state!==Qe.NONE||(i.preventDefault(),this.dispatchEvent(uo),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(Tc))}function Bg(i){this.enabled!==!1&&this._handleKeyDown(i)}function zg(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case Bn.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=Qe.TOUCH_ROTATE;break;case Bn.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=Qe.TOUCH_PAN;break;default:this.state=Qe.NONE}break;case 2:switch(this.touches.TWO){case Bn.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=Qe.TOUCH_DOLLY_PAN;break;case Bn.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=Qe.TOUCH_DOLLY_ROTATE;break;default:this.state=Qe.NONE}break;default:this.state=Qe.NONE}this.state!==Qe.NONE&&this.dispatchEvent(uo)}function Gg(i){switch(this._trackPointer(i),this.state){case Qe.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case Qe.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case Qe.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case Qe.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=Qe.NONE}}function Vg(i){this.enabled!==!1&&i.preventDefault()}function Hg(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function kg(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const $a=new vn,Rr=new Ih,yi=new Ie,ja=new U;class Wg extends Dg{constructor(e,t){super(e,t),this.screenSpacePanning=!1,this.mouseButtons={LEFT:Mn.PAN,MIDDLE:Mn.DOLLY,RIGHT:Mn.ROTATE},this.touches={ONE:Bn.PAN,TWO:Bn.DOLLY_ROTATE},this._panWorldStart=new U}_handleMouseDownPan(e){if(super._handleMouseDownPan(e),this._panOffset.set(0,0,0),this.screenSpacePanning===!0)return;$a.setFromNormalAndCoplanarPoint(this.object.up,this.target);const n=this.domElement.getBoundingClientRect();yi.x=(e.clientX-n.left)/n.width*2-1,yi.y=-((e.clientY-n.top)/n.height)*2+1,Rr.setFromCamera(yi,this.object),Rr.ray.intersectPlane($a,this._panWorldStart)}_handleMouseMovePan(e){if(this.screenSpacePanning===!0){super._handleMouseMovePan(e);return}const n=this.domElement.getBoundingClientRect();yi.x=(e.clientX-n.left)/n.width*2-1,yi.y=-((e.clientY-n.top)/n.height)*2+1,Rr.setFromCamera(yi,this.object),Rr.ray.intersectPlane($a,ja)&&(ja.sub(this._panWorldStart),this._panOffset.copy(ja).negate(),this.update())}}function Xg(i,e){const t=Math.max(1,Math.trunc(e));if(i.length===0)return{atlases:[{width:1,height:1,rgba:new Uint8Array([0,0,0,0])}],tiles:[]};const n=t-Vt*2;if(n<=0)throw new Error("Raster atlas padding exceeds available texture size.");const r=qg(i,n);if(r.length===0)return{atlases:[{width:1,height:1,rgba:new Uint8Array([0,0,0,0])}],tiles:[]};let a=r.slice().sort((l,c)=>l.height!==c.height?c.height-l.height:l.width!==c.width?c.width-l.width:l.id-c.id);const s=[],o=[];for(;a.length>0;){const l=Yg(a,t);if(!l||l.placements.length===0)throw new Error("Failed to pack raster tiles into GPU atlas textures.");const c=s.length,d=new Uint8Array(l.width*l.height*4);for(const u of l.placements){const m=i[u.layerIndex];m&&(jg(d,l.width,l.height,m,u),o.push({layerIndex:u.layerIndex,atlasIndex:c,sourceX:u.sourceX,sourceY:u.sourceY,width:u.width,height:u.height,uvRect:[u.x/l.width,u.y/l.height,u.width/l.width,u.height/l.height]}))}s.push({width:l.width,height:l.height,rgba:d});const p=new Set;for(const u of l.placements)p.add(u.id);a=a.filter(u=>!p.has(u.id))}return{atlases:s,tiles:o}}function qg(i,e){const t=[];let n=0;for(let r=0;r<i.length;r+=1){const a=i[r],s=Math.max(0,Math.trunc(a.width)),o=Math.max(0,Math.trunc(a.height));if(!(s<=0||o<=0)&&!(!(a.data instanceof Uint8Array)||a.data.length<s*o*4))for(let l=0;l<o;l+=e){const c=Math.min(e,o-l);for(let d=0;d<s;d+=e){const p=Math.min(e,s-d);t.push({id:n,layerIndex:r,sourceX:d,sourceY:l,width:p,height:c}),n+=1}}}return t}function Yg(i,e){const t=i.reduce((a,s)=>a+(s.width+Vt*2)*(s.height+Vt*2),0),n=i.reduce((a,s)=>Math.max(a,s.width+Vt*2),1);let r=Xr(Dl(Math.ceil(Math.sqrt(t))),n,e);for(;r<=e;){const a=$g(i,r,e);if(a.placements.length>0){const s=Xr(Dl(Math.max(1,a.usedHeight)),1,e);return{width:r,height:s,placements:a.placements}}if(r===e)break;r=Math.min(e,r*2)}return null}function $g(i,e,t){const n=[];let r=0,a=0,s=0,o=0;for(const l of i){const c=l.width+Vt*2,d=l.height+Vt*2;c>e||d>t||(r+c>e&&(r=0,a+=s,s=0),!(a+d>t)&&(n.push({...l,x:r+Vt,y:a+Vt}),r+=c,s=Math.max(s,d),o=Math.max(o,a+s)))}return{placements:n,usedHeight:o}}function jg(i,e,t,n,r){const a=r.sourceX,s=r.sourceY,o=r.sourceX+r.width-1,l=r.sourceY+r.height-1,c=r.x-Vt,d=r.y-Vt,p=r.x+r.width+Vt-1,u=r.y+r.height+Vt-1;for(let m=d;m<=u;m+=1){if(m<0||m>=t)continue;const _=Xr(m-r.y+r.sourceY,s,l);for(let S=c;S<=p;S+=1){if(S<0||S>=e)continue;const f=Xr(S-r.x+r.sourceX,a,o),h=(_*n.width+f)*4,M=(m*e+S)*4;i[M]=n.data[h],i[M+1]=n.data[h+1],i[M+2]=n.data[h+2],i[M+3]=n.data[h+3]}}}function Dl(i){if(i<=1)return 1;let e=1;for(;e<i;)e<<=1;return e}function Xr(i,e,t){return i<e?e:i>t?t:i}const Pr=4096;function Zg(i,e){const t=o_();e?.report(0,{stage:"upload",sourceType:void 0});const n=Xg(i.rasterLayers,t);e?.report(.15,{stage:"upload"});const r=n.atlases.map(j=>Qg(j.rgba,j.width,j.height)),a=Kg(i,n.tiles);e?.report(.3,{stage:"upload"});const s=new Float32Array(i.pageCount*4),o=new Float32Array(i.pageCount*4),l=new Float32Array(i.pageCount*4);for(let j=0;j<i.pages.length;j+=1){const J=i.pages[j],me=j*4;s[me]=J.segmentStart,s[me+1]=J.segmentCount,s[me+2]=J.fillPathStart,s[me+3]=J.fillPathCount,o[me]=J.textInstanceStart,o[me+1]=J.textInstanceCount,o[me+2]=a.pageRasterStarts[j],o[me+3]=a.pageRasterCounts[j],l[me]=J.pageRect[0],l[me+1]=J.pageRect[1],l[me+2]=J.pageRect[2],l[me+3]=J.pageRect[3]}const c=at(s,t),d=at(o,t),p=at(l,t);e?.report(.4,{stage:"upload"});const u=at(i.endpoints,t),m=at(i.primitiveMeta,t),_=at(i.styles,t),S=at(i.primitiveBounds,t);e?.report(.5,{stage:"upload"});const f=at(i.fillPathMetaA,t),h=at(i.fillPathMetaB,t),M=at(i.fillPathMetaC,t),b=at(i.fillSegmentsA,t),E=at(i.fillSegmentsB,t);e?.report(.62,{stage:"upload"});const R=at(i.textInstanceA,t),A=at(i.textInstanceB,t),D=at(i.textInstanceC,t),x=at(i.textGlyphMetaA,t),y=at(i.textGlyphMetaB,t),q=at(i.textGlyphSegmentsA,t),w=at(i.textGlyphSegmentsB,t);e?.report(.74,{stage:"upload"});const G=new Float32Array(a.primitives.length*4),B=new Float32Array(a.primitives.length*4),k=new Float32Array(a.primitives.length*4);for(let j=0;j<a.primitives.length;j+=1){const J=a.primitives[j],me=J.matrix,Ae=J.uvRect,ye=j*4;G[ye]=me[0]??1,G[ye+1]=me[1]??0,G[ye+2]=me[2]??0,G[ye+3]=me[3]??1,B[ye]=me[4]??0,B[ye+1]=me[5]??0,B[ye+2]=Ae[0],B[ye+3]=Ae[1],k[ye]=Ae[2],k[ye+1]=Ae[3],k[ye+2]=J.atlasIndex,k[ye+3]=0}const V=at(G,t),z=at(B,t),O=at(k,t);e?.report(.84,{stage:"upload"});const Q=s_(i,t),K=e_(Q.rgba,Q.width,Q.height),ce=at(Q.glyphUvRects,t);e?.report(.92,{stage:"upload"});const fe=Math.max(1,1+a.maxRasterPrimitiveCountPerPage),ue=Math.max(1,i.maxFillPathCountPerPage),De=Math.max(1,i.maxSegmentCountPerPage),et=Math.max(1,i.maxTextInstanceCountPerPage),Ye=i_(fe,ue,De,et,r.length);e?.complete({stage:"upload"});const $=[c.texture,d.texture,p.texture,u.texture,m.texture,_.texture,S.texture,f.texture,h.texture,M.texture,b.texture,E.texture,R.texture,A.texture,D.texture,x.texture,y.texture,q.texture,w.texture,ce.texture,V.texture,z.texture,O.texture,...r,K];return{document:i,maxTextureSize:t,geometry:Ye,maxRasterPrimitiveCount:fe,maxFillPrimitiveCount:ue,maxSegmentPrimitiveCount:De,maxTextPrimitiveCount:et,pageMetaTextureA:c,pageMetaTextureB:d,pageRectTexture:p,segmentTextureA:u,segmentTextureB:m,segmentTextureC:_,segmentTextureD:S,fillPathTextureA:f,fillPathTextureB:h,fillPathTextureC:M,fillSegmentTextureA:b,fillSegmentTextureB:E,textInstanceTextureA:R,textInstanceTextureB:A,textInstanceTextureC:D,textGlyphMetaTextureA:x,textGlyphMetaTextureB:y,textGlyphSegmentTextureA:q,textGlyphSegmentTextureB:w,textGlyphRasterMetaTexture:ce,rasterLayerMetaTextureA:V,rasterLayerMetaTextureB:z,rasterLayerMetaTextureC:O,rasterAtlasTextures:r,rasterAtlasSizes:n.atlases.map(j=>({width:j.width,height:j.height})),textAtlasTexture:K,textAtlasSize:{width:Q.width,height:Q.height},createInstancedGeometry:j=>a_(Ye,j),dispose:()=>{Ye.dispose();for(const j of $)j.dispose()}}}function Kg(i,e){const t=new Uint32Array(i.pageCount),n=new Uint32Array(i.pageCount),r=[],a=new Map;for(const o of e){const l=a.get(o.layerIndex);if(l){l.push(o);continue}a.set(o.layerIndex,[o])}for(const o of a.values())o.sort((l,c)=>l.sourceY!==c.sourceY?l.sourceY-c.sourceY:l.sourceX-c.sourceX);let s=0;for(let o=0;o<i.pages.length;o+=1){const l=i.pages[o],c=r.length,d=l.rasterLayerStart+l.rasterLayerCount;for(let u=l.rasterLayerStart;u<d;u+=1){const m=i.rasterLayers[u];if(!m)continue;const _=Math.max(1,Math.trunc(m.width)),S=Math.max(1,Math.trunc(m.height));if(_<=0||S<=0)continue;const f=a.get(u);if(!(!f||f.length===0))for(const h of f)r.push(Jg(m.matrix,_,S,h))}const p=r.length-c;t[o]=c,n[o]=p,s=Math.max(s,p)}return{primitives:r,pageRasterStarts:t,pageRasterCounts:n,maxRasterPrimitiveCountPerPage:s}}function Jg(i,e,t,n){const r=[Number(i[0]??1),Number(i[1]??0),Number(i[2]??0),Number(i[3]??1),Number(i[4]??0),Number(i[5]??0)],a=n.width/e,s=n.height/t,o=n.sourceX/e,l=n.sourceY/t,c=r[0]*a,d=r[1]*a,p=r[2]*s,u=r[3]*s,m=r[0]*o+r[2]*l+r[4],_=r[1]*o+r[3]*l+r[5];return{atlasIndex:n.atlasIndex,matrix:[c,d,p,u,m,_],uvRect:n.uvRect}}function at(i,e){const t=Math.floor(i.length/4),{width:n,height:r}=n_(t,e),a=new Float32Array(n*r*4);a.set(i.subarray(0,t*4));const s=new tr(a,n,r,Dt,Ht);return s.needsUpdate=!0,s.generateMipmaps=!1,s.minFilter=gt,s.magFilter=gt,s.wrapS=yt,s.wrapT=yt,{texture:s,width:n,height:r}}function Qg(i,e,t){const n=t_(i),r=new tr(n,e,t,Dt);return r.needsUpdate=!0,r.generateMipmaps=!0,r.minFilter=Sn,r.magFilter=pt,r.wrapS=yt,r.wrapT=yt,r.anisotropy=Jc,r}function e_(i,e,t){const n=new tr(i,e,t,Dt);return n.needsUpdate=!0,n.generateMipmaps=!0,n.minFilter=Sn,n.magFilter=pt,n.wrapS=yt,n.wrapT=yt,n}function t_(i){const e=new Uint8Array(i.length);for(let t=0;t+3<i.length;t+=4){const n=i[t+3];if(n<=0){e[t]=0,e[t+1]=0,e[t+2]=0,e[t+3]=0;continue}if(n>=255){e[t]=i[t],e[t+1]=i[t+1],e[t+2]=i[t+2],e[t+3]=255;continue}const r=n/255;e[t]=Math.round(i[t]*r),e[t+1]=Math.round(i[t+1]*r),e[t+2]=Math.round(i[t+2]*r),e[t+3]=n}return e}function n_(i,e){const t=Math.max(1,i),n=Math.ceil(Math.sqrt(t)),r=l_(n,1,e),a=Math.max(1,Math.ceil(t/r));if(a>e)throw new Error("Data texture exceeds GPU limits for this browser/GPU.");return{width:r,height:a}}function i_(i,e,t,n,r){const a=Math.max(1,Math.trunc(r)),s=i+e+t+n,o=s*4,l=s*6,c=new Float32Array(o*3),d=new Float32Array(o),p=new Uint32Array(l);let u=0,m=0,_=0;const S=new Ph,f=Dr(c,d,p,u,m,i);u=f.vertexOffset,m=f.indexOffset;for(let b=0;b<a;b+=1)S.addGroup(_,i*6,b);_+=i*6;const h=Dr(c,d,p,u,m,e);u=h.vertexOffset,m=h.indexOffset,S.addGroup(_,e*6,a),_+=e*6;const M=Dr(c,d,p,u,m,t);return u=M.vertexOffset,m=M.indexOffset,S.addGroup(_,t*6,a+1),_+=t*6,Dr(c,d,p,u,m,n),S.addGroup(_,n*6,a+2),S.setAttribute("position",new Ut(c,3)),S.setAttribute("aPrimitiveIndex",new Ut(d,1)),S.setIndex(new Ut(p,1)),S.instanceCount=1,S.boundingSphere=new ii(new U(0,0,0),1e9),S}function Dr(i,e,t,n,r,a){for(let s=0;s<a;s+=1){const o=r_(i,e,t,n,r,s);n=o.vertexOffset,r=o.indexOffset}return{vertexOffset:n,indexOffset:r}}function r_(i,e,t,n,r,a){const s=[[-1,-1],[1,-1],[-1,1],[1,1]];for(let o=0;o<4;o+=1){const l=n+o,c=l*3;i[c]=s[o][0],i[c+1]=s[o][1],i[c+2]=0,e[l]=a}return t[r]=n,t[r+1]=n+1,t[r+2]=n+2,t[r+3]=n+2,t[r+4]=n+1,t[r+5]=n+3,{vertexOffset:n+4,indexOffset:r+6}}function a_(i,e){const t=i.clone(),n=new Float32Array(e.length);for(let r=0;r<e.length;r+=1)n[r]=e[r];return t.setAttribute("aPageIndex",new Ws(n,1)),t.instanceCount=e.length,t.boundingSphere=new ii(new U(0,0,0),1e9),t}function s_(i,e){if(typeof i>"u"||i.textGlyphCount<=0)return{width:1,height:1,rgba:new Uint8Array([0,0,0,0]),glyphUvRects:new Float32Array(i.textGlyphCount*4)};const t={textGlyphCount:i.textGlyphCount,textGlyphMetaA:i.textGlyphMetaA,textGlyphMetaB:i.textGlyphMetaB,textGlyphSegmentsA:i.textGlyphSegmentsA,textGlyphSegmentsB:i.textGlyphSegmentsB},n=Qc(t,e);return n?{width:n.width,height:n.height,rgba:n.rgba,glyphUvRects:n.glyphUvRects}:{width:1,height:1,rgba:new Uint8Array([0,0,0,0]),glyphUvRects:new Float32Array(i.textGlyphCount*4)}}function o_(){if(typeof document>"u")return Pr;try{const i=document.createElement("canvas"),e=i.getContext("webgl2")||i.getContext("webgl");if(!e)return Pr;const t=e.getParameter(e.MAX_TEXTURE_SIZE),n=Number(t);return!Number.isFinite(n)||n<1?Pr:Math.max(1024,Math.min(Math.floor(n),16384))}catch{return Pr}}function l_(i,e,t){return i<e?e:i>t?t:i}function c_(i={}){return{maxPages:i.maxPages,extraction:i.extraction,worker:i.worker??"auto",page:{worldUnitsPerPoint:Za(i.page?.worldUnitsPerPoint??.01,1e-6,10),side:i.page?.side??Zt,depthWrite:i.page?.depthWrite??!1},material:{strokeCurveEnabled:i.material?.strokeCurveEnabled??!0,textVectorOnly:i.material?.textVectorOnly??!1,pageBackgroundColor:i.material?.pageBackgroundColor??16777215,pageBackgroundOpacity:Za(i.material?.pageBackgroundOpacity??1,0,1),vectorColorOverride:i.material?.vectorColorOverride??null,vectorOpacityOverride:Za(i.material?.vectorOpacityOverride??0,0,1)}}}function Za(i,e,t){return!Number.isFinite(i)||i<e?e:i>t?t:i}function Ll(i,e,t){const n=t==="instanced",r=n?{defines:{PDF_INSTANCED:"1"}}:{},a=new Ge(e.material.pageBackgroundColor),s=e.material.vectorColorOverride?new Ge(e.material.vectorColorOverride):new Ge(0,0,0),o=e.material.vectorColorOverride?e.material.vectorOpacityOverride:0,l=new qe,c=i.textAtlasTexture,d={uWorldUnitsPerPoint:{value:e.page.worldUnitsPerPoint},uPageIndex:{value:0},uPageMetaTexA:{value:i.pageMetaTextureA.texture},uPageMetaTexB:{value:i.pageMetaTextureB.texture},uPageRectTex:{value:i.pageRectTexture.texture},uPageMetaTexSize:{value:[i.pageMetaTextureA.width,i.pageMetaTextureA.height]},uPageRectTexSize:{value:[i.pageRectTexture.width,i.pageRectTexture.height]},uPageBackgroundColor:{value:[a.r,a.g,a.b,e.material.pageBackgroundOpacity]},uVectorOverride:{value:[s.r,s.g,s.b,o]},uStrokeCurveEnabled:{value:e.material.strokeCurveEnabled?1:0},uTextCurveEnabled:{value:e.material.strokeCurveEnabled?1:0},uTextVectorOnly:{value:e.material.textVectorOnly?1:0},uPanCacheEnabled:{value:0},uPanCacheViewProj:{value:l},uPanCacheTex:{value:c},uStrokeAAScreenPx:{value:1},uFillAAScreenPx:{value:1},uTextAAScreenPx:{value:1.25}},p=i.rasterAtlasTextures.map((f,h)=>new $i({glslVersion:Ei,transparent:!0,blending:kl,blendSrc:es,blendDst:Zi,blendSrcAlpha:es,blendDstAlpha:Zi,side:e.page.side,depthWrite:e.page.depthWrite,depthTest:!0,vertexShader:d_(n),fragmentShader:f_,uniforms:{...d,uRasterLayerTexA:{value:i.rasterLayerMetaTextureA.texture},uRasterLayerTexB:{value:i.rasterLayerMetaTextureB.texture},uRasterLayerTexC:{value:i.rasterLayerMetaTextureC.texture},uRasterLayerTexSize:{value:[i.rasterLayerMetaTextureA.width,i.rasterLayerMetaTextureA.height]},uRasterAtlasTex:{value:f},uRasterAtlasSize:{value:[i.rasterAtlasSizes[h]?.width??1,i.rasterAtlasSizes[h]?.height??1]},uRasterAtlasIndex:{value:h},uPanCachePrimaryPass:{value:h===0?1:0},uRasterPassIncludesBackground:{value:h===0?1:0}},...r})),u=new $i({glslVersion:Ei,transparent:!0,side:e.page.side,depthWrite:e.page.depthWrite,depthTest:!0,vertexShader:p_(n),fragmentShader:m_,uniforms:{...d,uFillPathMetaTexA:{value:i.fillPathTextureA.texture},uFillPathMetaTexB:{value:i.fillPathTextureB.texture},uFillPathMetaTexC:{value:i.fillPathTextureC.texture},uFillPathMetaTexSize:{value:[i.fillPathTextureA.width,i.fillPathTextureA.height]},uFillSegmentTexA:{value:i.fillSegmentTextureA.texture},uFillSegmentTexB:{value:i.fillSegmentTextureB.texture},uFillSegmentTexSize:{value:[i.fillSegmentTextureA.width,i.fillSegmentTextureA.height]},uPanCachePrimaryPass:{value:0}},...r}),m=new $i({glslVersion:Ei,transparent:!0,side:e.page.side,depthWrite:e.page.depthWrite,depthTest:!0,vertexShader:g_(n),fragmentShader:__,uniforms:{...d,uSegmentTexA:{value:i.segmentTextureA.texture},uSegmentTexB:{value:i.segmentTextureB.texture},uSegmentStyleTex:{value:i.segmentTextureC.texture},uSegmentBoundsTex:{value:i.segmentTextureD.texture},uSegmentTexSize:{value:[i.segmentTextureA.width,i.segmentTextureA.height]},uPanCachePrimaryPass:{value:0}},...r}),_=new $i({glslVersion:Ei,transparent:!0,side:e.page.side,depthWrite:e.page.depthWrite,depthTest:!0,vertexShader:x_(n),fragmentShader:v_,uniforms:{...d,uTextInstanceTexA:{value:i.textInstanceTextureA.texture},uTextInstanceTexB:{value:i.textInstanceTextureB.texture},uTextInstanceTexC:{value:i.textInstanceTextureC.texture},uTextInstanceTexSize:{value:[i.textInstanceTextureA.width,i.textInstanceTextureA.height]},uTextGlyphMetaTexA:{value:i.textGlyphMetaTextureA.texture},uTextGlyphMetaTexB:{value:i.textGlyphMetaTextureB.texture},uTextGlyphMetaTexSize:{value:[i.textGlyphMetaTextureA.width,i.textGlyphMetaTextureA.height]},uTextGlyphSegmentTexA:{value:i.textGlyphSegmentTextureA.texture},uTextGlyphSegmentTexB:{value:i.textGlyphSegmentTextureB.texture},uTextGlyphSegmentTexSize:{value:[i.textGlyphSegmentTextureA.width,i.textGlyphSegmentTextureA.height]},uTextGlyphRasterMetaTex:{value:i.textGlyphRasterMetaTexture.texture},uTextRasterAtlasTex:{value:i.textAtlasTexture},uTextRasterAtlasSize:{value:[i.textAtlasSize.width,i.textAtlasSize.height]},uPanCachePrimaryPass:{value:0}},...r}),S=[...p,u,m,_];return u_(S,e.page.side,e.page.depthWrite),{rasterPasses:p,fill:u,stroke:m,text:_,all:S,setMaterialOptions:f=>{if(h_(d,f),typeof f.strokeCurveEnabled=="boolean"&&(d.uStrokeCurveEnabled.value=f.strokeCurveEnabled?1:0,d.uTextCurveEnabled.value=f.strokeCurveEnabled?1:0),typeof f.textVectorOnly=="boolean"&&(d.uTextVectorOnly.value=f.textVectorOnly?1:0),f.pageBackgroundColor!==void 0||f.pageBackgroundOpacity!==void 0){const h=d.uPageBackgroundColor.value,M=new Ge(f.pageBackgroundColor??new Ge(h[0],h[1],h[2]));h[0]=M.r,h[1]=M.g,h[2]=M.b,f.pageBackgroundOpacity!==void 0&&(h[3]=Ka(f.pageBackgroundOpacity,0,1))}if(f.vectorColorOverride!==void 0||f.vectorOpacityOverride!==void 0){const h=d.uVectorOverride.value;if(f.vectorColorOverride===null)h[0]=0,h[1]=0,h[2]=0,h[3]=0;else if(f.vectorColorOverride!==void 0){const M=new Ge(f.vectorColorOverride);h[0]=M.r,h[1]=M.g,h[2]=M.b,h[3]=f.vectorOpacityOverride!==void 0?Ka(f.vectorOpacityOverride,0,1):h[3],f.vectorOpacityOverride===void 0&&h[3]<=0&&(h[3]=1)}else f.vectorOpacityOverride!==void 0&&(h[3]=Ka(f.vectorOpacityOverride,0,1))}for(const h of S)h.needsUpdate=!0},setPanCacheState:(f,h,M)=>{d.uPanCacheEnabled.value=f?1:0,d.uPanCacheViewProj.value.copy(h),d.uPanCacheTex.value=M},dispose:()=>{for(const f of S)f.dispose()}}}function u_(i,e,t){for(const n of i)n.side=e,n.depthWrite=t,n.toneMapped=!1}function h_(i,e){typeof e.strokeCurveEnabled=="boolean"&&(i.uStrokeCurveEnabled.value=e.strokeCurveEnabled?1:0,i.uTextCurveEnabled.value=e.strokeCurveEnabled?1:0),typeof e.textVectorOnly=="boolean"&&(i.uTextVectorOnly.value=e.textVectorOnly?1:0)}function oa(i){return`precision highp float;
...
`}const f_=`precision highp float;
precision highp sampler2D;
...
`}const m_=`precision highp float;
precision highp sampler2D;
...
`}const __=`precision highp float;
...
`}const v_=`precision highp float;
precision highp sampler2D;
...
`;function S_(i,e){for(const t of i)t.uniforms.uPageIndex&&(t.uniforms.uPageIndex.value=e)}function Ka(i,e,t){return i<e?e:i>t?t:i}class M_ extends _h{pageIndices;constructor(e,t,n,r,a){super(e,t,n.length),this.pageIndices=new Uint32Array(n.length),this.frustumCulled=!1;const s=new qe;for(let o=0;o<n.length;o+=1)this.pageIndices[o]=n[o],r&&r[o]?(r[o].updateMatrix(),s.copy(r[o].matrix)):s.identity(),this.setMatrixAt(o,s);this.instanceMatrix.needsUpdate=!0,this.onBeforeRender=(o,l,c)=>{a?.(o,l,c)}}}class T_ extends kt{pageIndex;pageWidthPt;pageHeightPt;materials;beforeRenderHook;constructor(e,t,n,r){super(t,n),this.pageIndex=e.pageIndex,this.pageWidthPt=e.widthPt,this.pageHeightPt=e.heightPt,this.materials=n,this.beforeRenderHook=r,this.frustumCulled=!1,this.onBeforeRender=(a,s,o)=>{S_(this.materials,this.pageIndex),this.beforeRenderHook?.(a,s,o)}}}const Il=1e-9,qi=1e-6;class y_{owner;fallbackTexture;materialSets=new Set;cacheTarget=null;cacheValid=!1;cacheEnabled=!1;invalidateRequested=!0;isRefreshingCache=!1;hasLastFrameCameraState=!1;lastHandledFrame=-1;lastContentHash=0;cacheViewProj=new qe;identity=new qe;cacheCamera=new ra;lastCameraWorld=new qe;lastCameraProjection=new qe;lastViewport=new Ie(0,0);cachedSourcePosition=new U;cachedSourceQuaternion=new Cn;cachedRightAxis=new U(1,0,0);cachedUpAxis=new U(0,1,0);cachedSourceLeft=-1;cachedSourceRight=1;cachedSourceTop=1;cachedSourceBottom=-1;cachedSourceZoom=1;tmpViewport=new Ie;tmpDelta=new U;tmpClearColor=new Ge;constructor(e,t){this.owner=e,this.fallbackTexture=t}registerMaterialSet(e){if(this.materialSets.add(e),this.cacheEnabled&&this.cacheTarget){e.setPanCacheState(!0,this.cacheViewProj,this.cacheTarget.texture);return}e.setPanCacheState(!1,this.identity,this.fallbackTexture)}unregisterMaterialSet(e){this.materialSets.delete(e)}invalidate(){this.invalidateRequested=!0,this.cacheValid=!1}onBeforeRender(e,t,n){if(this.isRefreshingCache||t===this.owner||e.info.render.frame===this.lastHandledFrame)return;e.getDrawingBufferSize(this.tmpViewport);const a=n;if(a.isOrthographicCamera!==!0){this.disablePanCache(),this.recordCameraState(n,this.tmpViewport),this.lastHandledFrame=e.info.render.frame;return}const s=this.tmpViewport.x!==this.lastViewport.x||this.tmpViewport.y!==this.lastViewport.y,o=this.hasLastFrameCameraState?!Ul(n.matrixWorld,this.lastCameraWorld,Il)||!Ul(n.projectionMatrix,this.lastCameraProjection,Il):!1,l=this.detectContentTransformChange(),c=s||l||this.invalidateRequested;if(!o){this.disablePanCache(),this.recordCameraState(n,this.tmpViewport),this.lastHandledFrame=e.info.render.frame;return}if(!this.ensureCacheTarget(e,this.tmpViewport)){this.disablePanCache(),this.recordCameraState(n,this.tmpViewport),this.lastHandledFrame=e.info.render.frame;return}this.shouldRefreshCache(a,c)&&this.refreshCache(e,a),this.cacheValid&&this.cacheTarget?(this.setPanCacheState(!0,this.cacheViewProj,this.cacheTarget.texture),this.cacheEnabled=!0):this.disablePanCache(),this.recordCameraState(n,this.tmpViewport),this.lastHandledFrame=e.info.render.frame}dispose(){this.disablePanCache(),this.cacheTarget?.dispose(),this.cacheTarget=null,this.materialSets.clear()}detectContentTransformChange(){const e=E_(this.owner),t=this.lastContentHash!==e;return this.lastContentHash=e,t&&(this.cacheValid=!1),t}shouldRefreshCache(e,t){if(t||!this.cacheValid||!this.cacheTarget||Math.abs(e.quaternion.dot(this.cachedSourceQuaternion))<.999999||e.left!==this.cachedSourceLeft||e.right!==this.cachedSourceRight||e.top!==this.cachedSourceTop||e.bottom!==this.cachedSourceBottom)return!0;const r=e.zoom/Math.max(this.cachedSourceZoom,qi);if(r<ru||r>au)return!0;this.tmpDelta.copy(e.position).sub(this.cachedSourcePosition);const a=Math.abs(this.tmpDelta.dot(this.cachedRightAxis)),s=Math.abs(this.tmpDelta.dot(this.cachedUpAxis)),o=Math.abs((e.right-e.left)/Math.max(e.zoom,qi))*.5,l=Math.abs((e.top-e.bottom)/Math.max(e.zoom,qi))*.5,c=Math.abs((this.cachedSourceRight-this.cachedSourceLeft)/Math.max(this.cachedSourceZoom,qi))*.5*Ni,d=Math.abs((this.cachedSourceTop-this.cachedSourceBottom)/Math.max(this.cachedSourceZoom,qi))*.5*Ni,p=c-o,u=d-l;return p<=0||u<=0?!0:a>p||s>u}refreshCache(e,t){if(!this.cacheTarget){this.cacheValid=!1;return}const n=e.getRenderTarget(),r=e.autoClear,a=e.getClearAlpha();e.getClearColor(this.tmpClearColor),this.cacheCamera.copy(t),this.cacheCamera.position.copy(t.position),this.cacheCamera.quaternion.copy(t.quaternion),this.cacheCamera.up.copy(t.up),this.cacheCamera.left=t.left,this.cacheCamera.right=t.right,this.cacheCamera.top=t.top,this.cacheCamera.bottom=t.bottom,this.cacheCamera.zoom=t.zoom/Ni,this.cacheCamera.updateProjectionMatrix(),this.cacheCamera.updateMatrixWorld(!0),this.isRefreshingCache=!0,this.setPanCacheState(!1,this.identity,this.fallbackTexture);try{e.autoClear=!0,e.setRenderTarget(this.cacheTarget),e.setClearColor(0,0),e.clear(!0,!0,!0),e.render(this.owner,this.cacheCamera),this.cacheViewProj.multiplyMatrices(this.cacheCamera.projectionMatrix,this.cacheCamera.matrixWorldInverse),this.cachedSourcePosition.copy(t.position),this.cachedSourceQuaternion.copy(t.quaternion),this.cachedRightAxis.set(1,0,0).applyQuaternion(this.cachedSourceQuaternion),this.cachedUpAxis.set(0,1,0).applyQuaternion(this.cachedSourceQuaternion),this.cachedSourceLeft=t.left,this.cachedSourceRight=t.right,this.cachedSourceTop=t.top,this.cachedSourceBottom=t.bottom,this.cachedSourceZoom=t.zoom,this.cacheValid=!0,this.invalidateRequested=!1}finally{this.isRefreshingCache=!1,e.setRenderTarget(n),e.setClearColor(this.tmpClearColor,a),e.autoClear=r}}ensureCacheTarget(e,t){const n=Math.max(1,Math.floor(t.x)),r=Math.max(1,Math.floor(t.y)),a=e.capabilities.maxTextureSize;if(a<n||a<r)return!1;const s=Fl(Math.ceil(n*Ni),n,a),o=Fl(Math.ceil(r*Ni),r,a);return s<=0||o<=0?!1:(this.cacheTarget&&this.cacheTarget.width===s&&this.cacheTarget.height===o||(this.cacheTarget?.dispose(),this.cacheTarget=new Jt(s,o,{depthBuffer:!0,stencilBuffer:!1}),this.cacheTarget.texture.generateMipmaps=!1,this.cacheTarget.texture.minFilter=pt,this.cacheTarget.texture.magFilter=pt,this.cacheTarget.texture.wrapS=yt,this.cacheTarget.texture.wrapT=yt,this.cacheValid=!1,this.invalidateRequested=!0),!0)}disablePanCache(){this.cacheEnabled&&(this.setPanCacheState(!1,this.identity,this.fallbackTexture),this.cacheEnabled=!1)}setPanCacheState(e,t,n){for(const r of this.materialSets)r.setPanCacheState(e,t,n)}recordCameraState(e,t){this.lastCameraWorld.copy(e.matrixWorld),this.lastCameraProjection.copy(e.projectionMatrix),this.lastViewport.copy(t),this.hasLastFrameCameraState=!0}}function Ul(i,e,t){const n=i.elements,r=e.elements;for(let a=0;a<16;a+=1)if(Math.abs(n[a]-r[a])>t)return!1;return!0}function E_(i){let e=2166136261;for(const t of i.children){e=b_(e,t.matrixWorld.elements);const n=t;n.instanceMatrix&&(e=yc(e,n.instanceMatrix.version??0))}return e>>>0}function b_(i,e){let t=i;for(let n=0;n<e.length;n+=1){const r=Number.isFinite(e[n])?Math.round(e[n]*1e6):0;t=yc(t,r)}return t}function yc(i,e){return Math.imul(i^(e|0),16777619)}function Fl(i,e,t){return i<e?e:i>t?t:i}class A_ extends bi{pages;pageCount;documentMetrics;textureMetrics;loadTiming;document;shared;options;pageMaterialSet;panCacheController;instancedMaterialSets=new Set;instancedGeometries=new Set;constructor(e,t,n,r){super(),this.document=e,this.shared=t,this.options=n,this.loadTiming={...r},this.documentMetrics=C_(e),this.textureMetrics=w_(t),this.pageMaterialSet=Ll(t,n,"mesh"),this.panCacheController=new y_(this,t.textAtlasTexture),this.panCacheController.registerMaterialSet(this.pageMaterialSet),this.pages=e.pages.map(a=>new T_(a,t.geometry,this.pageMaterialSet.all,(s,o,l)=>{this.panCacheController.onBeforeRender(s,o,l)})),this.pageCount=this.pages.length,this.pages.forEach(a=>this.add(a))}createInstancedPages(e){const t=e&&e.length>0?R_(e,this.pageCount):this.pages.map(o=>o.pageIndex),n=this.shared.createInstancedGeometry(t),r=Ll(this.shared,this.options,"instanced");this.panCacheController.registerMaterialSet(r),this.instancedMaterialSets.add(r),this.instancedGeometries.add(n);const a=t.map(o=>this.pages[o]),s=new M_(n,r.all,t,a,(o,l,c)=>{this.panCacheController.onBeforeRender(o,l,c)});return this.add(s),this.panCacheController.invalidate(),s}setMaterialOptions(e){this.pageMaterialSet.setMaterialOptions(e);for(const t of this.instancedMaterialSets)t.setMaterialOptions(e);this.panCacheController.invalidate()}getWorldBounds(e=new cn){e.makeEmpty();const t=this.options.page.worldUnitsPerPoint;if(!Number.isFinite(t)||t<=0||this.pages.length===0)return e;this.updateWorldMatrix(!0,!0);for(const n of this.pages){const r=n.pageWidthPt*t*.5,a=n.pageHeightPt*t*.5;for(const[s,o]of P_)Nl.set(s*r,o*a,0).applyMatrix4(n.matrixWorld),e.expandByPoint(Nl)}return e}dispose(){this.panCacheController.dispose(),this.pageMaterialSet.dispose();for(const e of this.instancedMaterialSets)e.dispose();this.instancedMaterialSets.clear();for(const e of this.instancedGeometries)e.dispose();this.instancedGeometries.clear(),this.shared.dispose();for(const e of[...this.children])this.remove(e)}}function C_(i){const e=i.stats;return{operatorCount:e.operatorCount,imagePaintOpCount:e.imagePaintOpCount,sourceSegmentCount:e.sourceSegmentCount,mergedSegmentCount:e.mergedSegmentCount,visibleSegmentCount:i.segmentCount,sourceTextCount:e.sourceTextCount,textInstanceCount:i.textInstanceCount,textGlyphCount:i.textGlyphCount,textGlyphSegmentCount:i.textGlyphSegmentCount,textInPageCount:e.textInPageCount,textOutOfPageCount:e.textOutOfPageCount,fillPathCount:i.fillPathCount,fillSegmentCount:i.fillSegmentCount,rasterLayerCount:i.rasterLayers.length,discardedTransparentCount:e.discardedTransparentCount,discardedDegenerateCount:e.discardedDegenerateCount,discardedDuplicateCount:e.discardedDuplicateCount,discardedContainedCount:e.discardedContainedCount,maxCellPopulation:e.maxCellPopulation,pageCount:i.pageCount}}function w_(i){return{fillPathTextureWidth:i.fillPathTextureA.width,fillPathTextureHeight:i.fillPathTextureA.height,fillSegmentTextureWidth:i.fillSegmentTextureA.width,fillSegmentTextureHeight:i.fillSegmentTextureA.height,segmentTextureWidth:i.segmentTextureA.width,segmentTextureHeight:i.segmentTextureA.height,textInstanceTextureWidth:i.textInstanceTextureA.width,textInstanceTextureHeight:i.textInstanceTextureA.height,textGlyphTextureWidth:i.textGlyphMetaTextureA.width,textGlyphTextureHeight:i.textGlyphMetaTextureA.height,textSegmentTextureWidth:i.textGlyphSegmentTextureA.width,textSegmentTextureHeight:i.textGlyphSegmentTextureA.height,rasterLayerMetaTextureWidth:i.rasterLayerMetaTextureA.width,rasterLayerMetaTextureHeight:i.rasterLayerMetaTextureA.height,rasterAtlasSizes:i.rasterAtlasSizes.map(e=>({width:e.width,height:e.height})),textAtlasWidth:i.textAtlasSize.width,textAtlasHeight:i.textAtlasSize.height,maxTextureSize:i.maxTextureSize}}function R_(i,e){const t=[],n=new Set;for(const r of i){const a=Math.trunc(r);a<0||a>=e||n.has(a)||(n.add(a),t.push(a))}if(t.length>0)return t;for(let r=0;r<e;r+=1)t.push(r);return t}const P_=[[-1,-1],[1,-1],[-1,1],[1,1]],Nl=new U;let Ol=!1;async function D_(i,e={}){L_();const t=Lr(),n=c_(e),r=su(e.onProgress);r.report(0,{stage:"source"});let a;if(n.worker!==!1)try{a=await ou(i,{maxPages:n.maxPages,extraction:n.extraction,worker:typeof n.worker=="object"?n.worker:{create:()=>new Worker(new URL(""+new URL("pdfLoadWorker-YmZWK1yB.js",import.meta.url).href,import.meta.url),{type:"module"})},progress:r.child(0,.985,{executionPath:"worker"})})}catch(p){if(n.worker!=="auto")throw p;a=await Bl(i,{maxPages:n.maxPages,extraction:n.extraction,progress:r.child(0,.985,{executionPath:"main-thread-fallback"})})}else a=await Bl(i,{maxPages:n.maxPages,extraction:n.extraction,progress:r.child(0,.985,{executionPath:"main-thread"})});const s=Lr(),o=Lr(),l=Zg(a,r.child(.985,.998,{stage:"upload"})),c=Lr(),d=new A_(a,l,n,{parseMs:Math.max(0,s-t),uploadMs:Math.max(0,c-o),totalMs:Math.max(0,c-t)});return r.complete({stage:"complete"}),d}async function Bl(i,e){return cu(i,e)}function L_(){Ol||(fu.workerSrc=lu,Ol=!0)}function Lr(){return typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}const Ec=document.querySelector("#viewport"),bc=document.querySelector("#open-file"),Ai=document.querySelector("#file-input"),st=document.querySelector("#example-select"),Ac=document.querySelector("#status"),Cc=document.querySelector("#parse-loader"),wc=document.querySelector("#parse-loader-text"),Rc=document.querySelector("#runtime"),ho=document.querySelector("#metrics"),fo=document.querySelector("#metric-file"),qr=document.querySelector("#metric-operators"),Yr=document.querySelector("#metric-source-segments"),$r=document.querySelector("#metric-merged-segments"),jr=document.querySelector("#metric-visible-segments"),Zr=document.querySelector("#metric-reductions"),Kr=document.querySelector("#metric-cull-discards"),Jr=document.querySelector("#metric-times"),Pc=document.querySelector("#metric-fps"),Qr=document.querySelector("#metric-texture"),ea=document.querySelector("#metric-grid-max-cell"),Dc=document.querySelector("#load-debug"),Lc=document.querySelector("#load-debug-log"),Ic=document.querySelector("#drop-indicator"),po=document.querySelector("#toggle-stroke-curves"),mo=document.querySelector("#toggle-vector-text-only"),go=document.querySelector("#page-bg-color"),ca=document.querySelector("#page-bg-opacity"),Uc=document.querySelector("#page-bg-opacity-value"),_o=document.querySelector("#vector-color"),ua=document.querySelector("#vector-opacity"),Fc=document.querySelector("#vector-opacity-value");if(!Ec||!bc||!Ai||!st||!Ac||!Cc||!wc||!Rc||!ho||!fo||!qr||!Yr||!$r||!jr||!Zr||!Kr||!Jr||!Pc||!Qr||!ea||!Dc||!Lc||!Ic||!po||!mo||!go||!ca||!Uc||!_o||!ua||!Fc)throw new Error("Required UI elements are missing from three-example.html.");const ri=new Rg({canvas:Ec,antialias:!0,alpha:!0});ri.setPixelRatio(Math.min(window.devicePixelRatio||1,2));ri.setSize(window.innerWidth,window.innerHeight,!1);ri.outputColorSpace=Bt;const ha=new uh;ha.background=new Ge("#f3f5f8");const an=new ra(-1,1,1,-1,-2e3,2e3);an.position.set(0,0,100);const Qt=new Wg(an,ri.domElement);Qt.enableRotate=!1;Qt.enableDamping=!0;Qt.dampingFactor=.08;Qt.zoomSpeed=1.15;Qt.panSpeed=.85;Qt.screenSpacePanning=!0;const I_=new Rh(16777215,.95);ha.add(I_);const xo=new bi;ha.add(xo);let ut=null,Ui=!1,vo=!1;const Jn=new Map;let Ja=0,Ir=0,da=0;const Nc=new URLSearchParams(window.location.search).get("loadDebug")==="1",Wt=uu({statusElement:Ac,loaderElement:Cc,loaderTextElement:wc,runtimeElement:Rc,fpsElement:Pc,debugElement:Dc,debugLogElement:Lc},{runtimeThrottleMs:250,fpsThrottleMs:250,debugEnabled:Nc,debugMaxLines:200}),So=hu({enabled:Nc,tag:"hepr/three",emitLine(i){console.log(i),Wt.appendDebugLine(i)},minDelta:.03,minIntervalMs:2e3}),$s=.01;function Gn(i){Wt.setStatus(i)}function U_(i){da=i,vo=!0,Qt.enabled=!1,Wt.setLoader(!0,"Parsing / loading 0.00%")}function F_(i,e){Wt.clearDebug(),So.begin(i,e)}function N_(i,e){if(i!==da)return;So.update(i,e);const t=du(e.stage),n=e.executionPath?` [${e.executionPath}]`:"",r=Math.max(0,Math.min(1,Number(e.value)||0));Wt.setLoader(!0,`${t}${n} ${(r*100).toFixed(2)}%`)}function zl(i,e=!0){i===da&&(vo=!1,Qt.enabled=!0,Wt.setLoader(!1,""))}function Gl(i,e,t){So.finish(i,e,t)}function Vl(i){return`${Math.max(0,Math.min(100,Math.trunc(i)))}%`}function js(i="-"){fo.textContent=i,qr.textContent="-",Yr.textContent="-",$r.textContent="-",jr.textContent="-",Zr.textContent="-",Kr.textContent="-",Jr.textContent="-",Qr.textContent="-",ea.textContent="-",ho.dataset.ready="false",Wt.setFps("-")}function O_(i,e){fo.textContent=i;const t=ut?ut.documentMetrics:null,n=ut?ut.textureMetrics:null,r=ut?ut.loadTiming:null;if(t){const a=Math.max(0,Number(t.sourceSegmentCount)||0),s=Math.max(0,Number(t.mergedSegmentCount)||0),o=Math.max(0,Number(t.visibleSegmentCount)||0),l=a>0?(1-s/a)*100:0,c=s>0?(1-o/s)*100:0,d=a>0?(1-o/a)*100:0;qr.textContent=t.operatorCount.toLocaleString(),Yr.textContent=a.toLocaleString(),$r.textContent=`${s.toLocaleString()} (${l.toFixed(1)}% reduction)`,jr.textContent=`${o.toLocaleString()} (${d.toFixed(1)}% total reduction), fills ${t.fillPathCount.toLocaleString()}, text ${t.textInstanceCount.toLocaleString()} instances, pages ${t.pageCount.toLocaleString()}, raster ${t.rasterLayerCount.toLocaleString()} layers`,Zr.textContent=`merge ${l.toFixed(1)}%, invisible-cull ${c.toFixed(1)}%, total ${d.toFixed(1)}%`,Kr.textContent=`transparent ${t.discardedTransparentCount.toLocaleString()}, degenerate ${t.discardedDegenerateCount.toLocaleString()}, duplicates ${t.discardedDuplicateCount.toLocaleString()}, contained ${t.discardedContainedCount.toLocaleString()}, glyphs ${t.textGlyphCount.toLocaleString()} / glyph segments ${t.textGlyphSegmentCount.toLocaleString()}`,ea.textContent=t.maxCellPopulation.toLocaleString()}else qr.textContent="0",Yr.textContent="0",$r.textContent="0",jr.textContent="0",Zr.textContent="0.0%",Kr.textContent="0",ea.textContent="0";if(r?Jr.textContent=`parse ${Math.max(0,r.parseMs).toFixed(0)} ms, upload ${Math.max(0,r.uploadMs).toFixed(0)} ms, total ${Math.max(0,r.totalMs).toFixed(0)} ms`:Jr.textContent=`load ${Math.max(0,e).toFixed(0)} ms`,n){const a=`${n.fillPathTextureWidth}x${n.fillPathTextureHeight}`,s=`${n.fillSegmentTextureWidth}x${n.fillSegmentTextureHeight}`,o=`${n.segmentTextureWidth}x${n.segmentTextureHeight}`,l=`${n.textInstanceTextureWidth}x${n.textInstanceTextureHeight}`,c=`${n.textGlyphTextureWidth}x${n.textGlyphTextureHeight}`,d=`${n.textSegmentTextureWidth}x${n.textSegmentTextureHeight}`,p=n.rasterAtlasSizes.length>0?n.rasterAtlasSizes.map(u=>`${u.width}x${u.height}`).join(", "):"-";Qr.textContent=`fill paths ${a}, fill seg ${s}, segments ${o}, text inst ${l}, glyph ${c}, glyph-seg ${d}, raster atlas ${p}, max ${n.maxTextureSize}x${n.maxTextureSize}`}else Qr.textContent="0";ho.dataset.ready="true"}function B_(){const i=performance.now();if(Ja>0){const e=i-Ja;if(e>0){const t=1e3/e;Ir=Ir===0?t:Ir*.85+t*.15,Wt.setFps(`${Ir.toFixed(0)} FPS`)}}Ja=i}function z_(){if(!ut){Wt.setRuntime("");return}const i=ri.info.render;Wt.setRuntime(`Draw calls ${i.calls.toLocaleString()} | triangles ${i.triangles.toLocaleString()} | lines ${i.lines.toLocaleString()} | points ${i.points.toLocaleString()}`)}function Oc(){const i=Math.max(0,Math.min(1,Number(ca.value)/100)),e=Math.max(0,Math.min(1,Number(ua.value)/100));return{strokeCurveEnabled:po.checked,textVectorOnly:mo.checked,pageBackgroundColor:go.value,pageBackgroundOpacity:i,vectorColorOverride:e>0?_o.value:null,vectorOpacityOverride:e}}function ai(){Uc.textContent=Vl(ca.value),Fc.textContent=Vl(ua.value),ut&&ut.setMaterialOptions(Oc())}function ti(){const i=Ui||!ut;Ic.classList.toggle("active",i)}function G_(){ut&&(xo.remove(ut),ut.dispose(),ut=null,Wt.setRuntime(""),Wt.setFps("-"))}function V_(i){if(i.length===0)return;const e=Math.max(1,Math.ceil(Math.sqrt(i.length)));let t=0,n=0;for(const l of i)t=Math.max(t,l.pageWidthPt*$s),n=Math.max(n,l.pageHeightPt*$s);const r=Math.max(.2,Math.min(t,n)*.08);for(let l=0;l<i.length;l+=1){const c=i[l],d=l%e,p=Math.floor(l/e),u=d*(t+r),m=-p*(n+r);c.position.set(u,m,0),c.rotation.set(0,0,0),c.scale.set(1,1,1)}const a=Math.ceil(i.length/e),s=e*t+(e-1)*r,o=a*n+(a-1)*r;for(const l of i)l.position.x-=s*.5-t*.5,l.position.y+=o*.5-n*.5}function Bc(i){const e=typeof i?.getWorldBounds=="function"?i.getWorldBounds(new cn):new cn().setFromObject(i);if(e.isEmpty())return;const t=e.getSize(new U),n=e.getCenter(new U),r=Math.max(t.x,.1),a=Math.max(t.y,.1),s=Math.max(window.innerWidth/Math.max(window.innerHeight,1),1e-6),o=1.08;let l,c;r/a>s?(l=r*o*.5,c=l/s):(c=a*o*.5,l=c*s),an.left=-l,an.right=l,an.top=c,an.bottom=-c,an.position.set(n.x,n.y,100),an.updateProjectionMatrix(),Qt.target.copy(n),Qt.update()}function zc(i){const e=i.name.toLowerCase();return i.type==="application/pdf"||e.endsWith(".pdf")}function Gc(i){return i.name.toLowerCase().endsWith(".zip")||i.type==="application/zip"||i.type==="application/x-zip-compressed"}async function Vc(i,e){const t=da+1;U_(t),F_(t,e),Gn(`Loading ${e}...`),js(e),G_(),ti();try{const n=performance.now();ut=await D_(i,{worker:"auto",onProgress:s=>{N_(t,s)},page:{worldUnitsPerPoint:$s,depthWrite:!1,side:Zt},material:Oc()}),V_(ut.pages),xo.add(ut),Bc(ut),ti();const a=performance.now()-n;O_(e,a),zl(t,!0),Gl(t,!0),Gn(`${e} loaded | pages ${ut.pageCount.toLocaleString()} | drag to pan, wheel to zoom`)}catch(n){zl(t,!1);const r=n instanceof Error?n.message:String(n);Gl(t,!1,r),js(e),r.includes("v3 is unsupported")?Gn(`Failed to load ${e}: ${r}`):Gn(`Failed to load ${e}: ${r}`)}}async function Hc(i){if(!zc(i)&&!Gc(i)){Gn(`Unsupported file type: ${i.name}`);return}await Vc(i,i.name)}function Qa(i){const e=i.trim();if(/^[a-z][a-z\d+.-]*:/i.test(e))return e;const t=e.replace(/^\/+/,""),n=new URL("./",window.location.href);return new URL(t,n).toString()}function Hl(i){return(Math.max(0,Number(i)||0)/1024).toFixed(1)}async function H_(){Jn.clear(),st.innerHTML="",st.append(new Option("Examples (loading...)","")),st.value="",st.disabled=!0;try{const i=Qa("examples/manifest.json"),e=await fetch(i,{cache:"no-store"});if(!e.ok)throw new Error(`HTTP ${e.status}`);const t=await e.json(),n=Array.isArray(t.examples)?t.examples:[];st.innerHTML="",st.append(new Option("Load example...",""));for(const r of n){if(!r||typeof r!="object")continue;const a=typeof r.name=="string"?r.name:null,s=typeof r.id=="string"?r.id:null,o=typeof r.pdf?.path=="string"?r.pdf.path:null,l=typeof r.parsedZip?.path=="string"?r.parsedZip.path:null;if(!a||!s||!o||!l)continue;const c=document.createElement("optgroup");c.label=a;const d=Qa(o),p=Qa(l),u=Hl(r.pdf?.sizeBytes),m=Hl(r.parsedZip?.sizeBytes),_=`${s}:pdf`,S=`${s}:zip`;Jn.set(_,{name:a,kind:"pdf",path:d}),Jn.set(S,{name:a,kind:"zip",path:p}),c.append(new Option(`Parse PDF (${u} kB)`,_)),c.append(new Option(`Load Parsed ZIP (${m} kB)`,S)),st.append(c)}st.disabled=Jn.size===0,st.value="",Jn.size===0&&(st.innerHTML="",st.append(new Option("Examples unavailable","")),st.disabled=!0)}catch(i){const e=i instanceof Error?i.message:String(i);console.warn(`[three-example] Failed to load examples manifest: ${e}`),st.innerHTML="",st.append(new Option("Examples unavailable","")),st.value="",st.disabled=!0}}async function k_(i){const e=Jn.get(i);if(!e){st.value="";return}st.disabled=!0;try{const t=e.kind==="pdf"?"PDF":"parsed ZIP";Gn(`Loading example ${e.name} (${t})...`);const n=e.kind==="pdf"?e.name:`${e.name} (parsed zip)`;await Vc(e.path,n)}catch(t){const n=t instanceof Error?t.message:String(t);Gn(`Failed to load example: ${n}`)}finally{st.value="",st.disabled=Jn.size===0}}function kc(){const i=Math.max(window.innerWidth,1),e=Math.max(window.innerHeight,1);ri.setSize(i,e,!1),ut?Bc(ut):an.updateProjectionMatrix()}function Wc(){requestAnimationFrame(Wc),!vo&&(Qt.update(),ri.render(ha,an),B_(),z_())}bc.addEventListener("click",()=>Ai.click());Ai.addEventListener("change",async()=>{const i=Ai.files&&Ai.files[0];i&&(await Hc(i),Ai.value="")});st.addEventListener("change",()=>{const i=st.value;i&&k_(i)});window.addEventListener("dragenter",i=>{i.preventDefault(),Ui=!0,ti()});window.addEventListener("dragover",i=>{i.preventDefault(),Ui||(Ui=!0,ti())});window.addEventListener("dragleave",i=>{(i.target===document.documentElement||i.target===document.body)&&(Ui=!1,ti())});window.addEventListener("drop",async i=>{i.preventDefault(),Ui=!1,ti();const t=Array.from(i.dataTransfer?.files||[]).find(n=>zc(n)||Gc(n));if(!t){Gn("Dropped file is not a supported PDF or parsed ZIP.");return}await Hc(t)});window.addEventListener("resize",kc);po.addEventListener("change",ai);mo.addEventListener("change",ai);go.addEventListener("input",ai);ca.addEventListener("input",ai);_o.addEventListener("input",ai);ua.addEventListener("input",ai);ai();js();ti();kc();H_();Wc();
